...
$_QRY_docMain = mysqlQuery("SELECT inbox_rowID_rel, inbox_rowIDadd_rel, inbox_rowIDs_links, outbox_rowIDs_links, dognet_rowIDs_links FROM " . __MAIL_OUTGOING_TABLENAME . " WHERE koddocmail='" . $_koddocmail . "'");
