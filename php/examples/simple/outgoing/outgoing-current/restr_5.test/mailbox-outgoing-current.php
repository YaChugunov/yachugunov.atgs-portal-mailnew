    ...
    switch ($_GET['mode']) {
        ...
        case 'archive':
            if (isset($_GET['year']) && $_GET['year'] >= 2010 && $_GET['year'] <= date('Y')) {
                ...
                $_SESSION['outArch_startTableDate'] = $startTableDate;
                $endTableDate = '"' . $_GET["year"] . '-12-31 23:59:59"';
                $_SESSION['outArch_endTableDate'] = $endTableDate;
            } else {
...
<script type="text/javascript" language="javascript" class="init">
    ...
    function ajaxRequest_saveToDB_showIspolOnly(responseHandler) {
        ...
        request_showIspolOnly = $.ajax({
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-saveShowIspolonly.php',
            type: "post",
            cache: false,
            data: {
                userID: _userid,
    ...
    function ajaxRequest_loadFromDB_showIspolOnly(responseHandler) {
        ...
        // Fire off the request_addItem to /form.php
        request_showIspolOnly = $.ajax({
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getShowIspolonly.php',
            type: "post",
            cache: false,
            data: {
                userID: _userid
    ...
    function ajaxRequest_uploadAttachedFiles(formData, responseHandler) {
        ...
        request_uploadAttachedFiles = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-uploadAttachedFiles.php',
            cache: false,
            contentType: false,
            processData: false,
            data: formData,
    ...
    function ajaxRequest_listAttachedFiles(koddocmail, responseHandler) {
        ...
        request_listAttachedFiles = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-listAttachedFiles.php',
            cache: false,
            data: {
    ...
    function ajaxRequest_deleteAttachedFile(rowid, responseHandler) {
        ...
        request_deleteAttachedFile = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-deleteAttachedFile.php',
            cache: false,
            data: {
                rowID: rowid
            },
    ...
    function ajaxRequest_getLastDeadlineMail(koddocmail, userid, responseHandler) {
        ...
        request_getLastDeadlineMail = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getLastDeadlineMail.php',
            cache: false,
            data: {
                koddocmail: koddocmail,
                userid: userid
    ...
    function ajaxRequest_getLastNotify(action, koddocmail, parameter, responseHandler) {
        ...
        request_getLastNotify = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getLastNotify.php',
            cache: false,
            data: {
                koddocmail: koddocmail,
                parameter: parameter,
    ...
    function ajaxRequest_getLastAction(koddocmail, parameter, responseHandler) {
        ...
        request_getLastAction = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getLastAction.php',
            cache: false,
            data: {
                koddocmail: koddocmail,
                parameter: parameter
    ...
    function ajaxRequest_getLinkedRelFiles(koddocmail, responseHandler) {
        ...
        request_getLinkedRelFiles = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getLinkedRelFiles.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_countDocComments(koddocmail, responseHandler) {
        ...
        request_countDocComments = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-countDocComments.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_getUserCheckout(koddocmail, userid, responseHandler) {
        ...
        request_getUserCheckout = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getUserCheckout.php',
            cache: false,
            data: {
                userid: userid,
                koddocmail: koddocmail
    ...
    function ajaxRequest_getFormFieldHelp(fieldname, responseHandler) {
        ...
        request_getFormFieldHelp = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getFormFieldHelp.php',
            cache: false,
            data: {
                fieldname: fieldname,
            },
    ...
    function ajaxRequest_getDocTypeLock(koddocmail, responseHandler) {
        ...
        request_getDocTypeLock = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getDocTypeLock.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_getRelativeIncomingDataAsync(rowid) {
        ...
        $.ajax({
            ...
            cache: false,
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getRelativeIncomingData.php',
            data: {
                rowid: rowid
            },
            success: function(response) {
                ...
                if (response != 'no data' && response != 'error -2' && response != 'error -3') {
                    ...
                    // Список параметров ВХОДЯЩЕГО документа, возвращаемых функциией в виде массива
                    // result[0] - id
                    // result[1] - koddocmail
                    // result[2] - inbox_docSender_kodzakaz
                    // result[3] - inbox_controlIspolActive
                    // result[4] - inbox_controlIspolStatus
                    // result[5] - ispolMe = 1 (пользователь входит в исполнители) или 2 (не входит)
                    // result[6] - outbox_docID_rel или 'no'
                    // result[7] - outbox_rowID_rel или 'no'
                    // result[8] - outbox_koddocmail_rel : 'no'
                    // result[9] - inbox_controlIspolActive

                    // Список параметров ИСХОДЯЩЕГО документа, возвращаемых функциией в виде того же массива
                    // result[10] - outbox_docDate
                    // result[11] - outbox_docAbout
    ...
    function ajaxRequest_checkInUseDocStateDataAsync(action, koddocmail) {
        ...
        $.ajax({
            ...
            cache: false,
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-checkInUseDocState.php',
            data: {
                action: action,
                koddocmail: koddocmail
            },
            success: function(response) {
                ...
                if (response !== 'error on set' && response !== 'error on unset' && response !==
                    ...
                    response !==
                    'error -1' && response !== 'error -2' && response !== 'unset all user docs' && response !==
                    'error on unset all') {
                    // resArr = JSON.parse(response);
                    // result = response.replace(new RegExp("\\r?\\n", "g"), "");
                    result = JSON.parse(response);
                } else if (response === 'unset all user docs') {
                    result = response;
                } else {
                    result = 'no result';
                }
    ...
    $(document).ready(function() {
        editor_outgoing = new $.fn.dataTable.Editor({
            display: "bootstrap",
            ajax: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process.php",
            table: "#outbox",
            formOptions: {
                main: {
        ...
        editor_outgoing.on('open', function() {
            ...
            if ($('#popoverCheckboxEnable').prop('checked')) {
                $.getJSON(
                        "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/fields-help-data.json"
                    )
                    .done(function(json) {
                        console.log("----- getJSON >>>>>");
                        let placement = 'top';
        ...
        editor_outgoing.on('preOpen', function(e, mode, action) {
            ...
            if (action === "create") {
                ...
                let setControlIspolOnStart =
                    '<?php echo $_SESSION['outgoing_setControlIspolOnStart']; ?>';
        ...
        editor_outgoing.on('open', function(e, mode, action) {
                ...
                editor_outgoing.on('preSubmit', function(e, data, action) {
                    ...
                    if (action !== "remove") {
                        ...
                        //
                        // Вкладка TAB-4
                        if ($('#doc-editor-tab-1 span.select2-selection__rendered').text() === '' || $(
                                '#doc-editor-tab-1 span.select2-selection__rendered').text() ===
                ...
                $('#mailbox-rel-links-btnAdd').click(function() {
                    if (editor_outgoing.field(
                        ...
                        // А также проверяем заполнена ли основная привязка. Если нет, то в первую очередь добавляем связь туда
                        var exists = 0 != $('#linked-mail-listDocs option[value=' + selValue + ']')
                            .length;
                        if (!exists) {
                            if (editor_outgoing.field(
                                    '<?php echo __MAIL_OUTGOING_TABLENAME; ?>.inbox_rowID_rel')
                                .val() !==
                                "") {
                                // UPDATE 20230814-01 <<<<<
        ...
        //
        //
        editor_outgoing.on('postSubmit close', function(e, json, data, action, xhr) {
            ...
            function(val, data, callback, e) {
                if (val !== "" && val !== null) {
                    ...
                    if (relVal[6] !== 'no' && relVal[7] !== 'no' && relVal[8] !== 'no') {
                        $('div.inbox-relExist-alert').css('display', 'block');
                        $('div.inbox-relExist-alert .inbox-relExist-alert-msg').html(
                            '<p class="mb-1"><b>На этот документ ранее уже был дан ответ в другом документе:</b><br><span class=""><a href="<?php echo __ROOT . __SERVICENAME_MAILNEW; ?>/index.php?type=out&mode=thisyear&rel=' +
                            relVal[8] + '">Исходящее # 1-1/' + relVal[6] + ' от ' + relVal[9] + ' - ' +
                            relVal[10] +
                        ...
                        $('#select2-DTE_Field_mailbox_outgoing-inbox_rowID_rel-container').addClass(
                            'text-danger');
                        $('input[id="DTE_Field_enbl_inbox_rowIDadd_rel_0"]').prop('checked', true);
                        editor_outgoing.field('enbl_inbox_rowIDadd_rel').val(1);
                        editor_outgoing.field(
                            '<?php echo __MAIL_OUTGOING_TABLENAME; ?>.inbox_rowIDList_rel').val(relVal[0]);
                    } else {
                        $('div.inbox-relExist-alert').css('display', 'none');
                        $('div.inbox-relExist-alert .inbox-relExist-alert-msg').html('');
                        $('#select2-DTE_Field_mailbox_outgoing-inbox_rowID_rel-container').removeClass(
                            'text-danger');
                    ...
                    $('input#DTE_Field_enbl_inbox_docType_change_0').prop('checked', true);
                    $('input#DTE_Field_enbl_inbox_docType_change_0').prop('disabled', true);
                } else {
        ...
        // console.log('->>> Current check point #1', editor_outgoing.field(
        //     '<?php echo __MAIL_OUTGOING_TABLENAME; ?>.inbox_rowID_rel').val());
        if (editor_outgoing.field('<?php echo __MAIL_OUTGOING_TABLENAME; ?>.inbox_rowID_rel').val() == null ||
            editor_outgoing.field('<?php echo __MAIL_OUTGOING_TABLENAME; ?>.inbox_rowID_rel').val() == '') {
        ...
        //
        //
        // editor_outgoing.dependent('<?php echo __MAIL_OUTGOING_TABLENAME; ?>.inbox_rowIDList_rel',
        //     function(val, data, callback, e) {
        //         callback(true);
        //     }
        // );
        ...
        table_outgoing = $('#outbox').DataTable({
            ...
            language: {
                url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/dt_russian-mail.json"
            },
            ajax: {
                url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process.php",
                type: "POST"
            },
            serverSide: true,
            stateSave: true,
        ...
        //
        //
        $(document).on("click", "button#mailbox-rel-links-btnAdd, button#mailbox-rel-links-btnRemove", function() {
            if ($('select#linked-mail-listDocs option').length > 0) {
                $('#inbox-rowIDadd-dopmsg-rel-alert').css('display', 'block');
            } else {
                $('#inbox-rowIDadd-dopmsg-rel-alert').css('display', 'none');
            }
        });
        //
        //
        $(document).on("click", "div#link-logCheckouts", function() {
            ...
            $('#table-logCheckouts').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogCheckouts.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-logChanges", function() {
            ...
            $('#table-logChanges').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogChanges.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-logComments", function() {
            ...
            */
            ...
            editor_logComments = new $.fn.dataTable.Editor({
                display: "bootstrap",
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogComments.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-listAddFiles", function() {
            ...
            */
            ...
            editor_listAddFiles = new $.fn.dataTable.Editor({
                display: "bootstrap",
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogAddFiles.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-listLinkDocs", function() {
            ...
            */
            ...
            table_listLinkDocs = $('#table-listLinkDocs').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogLinkDocs.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
            ...
            */
            var table_listAdditionalLinkDocsDog = $('#table-listAdditionalLinkDocsDog').dataTable({
                dom: "<'row'<'col-sm-5'><'col-sm-4'><'col-sm-3'>>" +
                    "<'row'<'col-sm-12't>>" + "<'row'<'col-sm-8'><'col-sm-4'>>",
                language: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/dt_russian-docDogLinks.json"
                },
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogAdditionalLinkDocsDog.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
            ...
            var table_listAdditionalLinkDocsSP = $('#table-listAdditionalLinkDocsSP').dataTable({
                dom: "<'row'<'col-sm-5'><'col-sm-4'><'col-sm-3'>>" +
                    "<'row'<'col-sm-12't>>" + "<'row'<'col-sm-8'><'col-sm-4'>>",
                language: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/dt_russian-docSPLinks.json"
                },
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogAdditionalLinkDocsSP.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
            ...
            var table_listAdditionalLinkDocsMOut = $('#table-listAdditionalLinkDocsMOut').dataTable({
                dom: "<'row'<'col-sm-5'><'col-sm-4'><'col-sm-3'>>" +
                    "<'row'<'col-sm-12't>>" + "<'row'<'col-sm-8'><'col-sm-4'>>",
                language: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/dt_russian-docMailLinks.json"
                },
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogAdditionalLinkDocsMOut.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
            ...
            var table_listAdditionalLinkDocsMInc = $('#table-listAdditionalLinkDocsMInc').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogAdditionalLinkDocsMInc.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
...
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/css/common-modals.css">
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/css/common-customform.css">
<?php
// ----- ----- ----- ----- -----
// Подключаем форму и выводим таблицу входящей почты
// :::
include __DIR_ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5 . "/forms/mailbox-outgoing-customForm.php";
include __DIR_ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5 . "/forms/mailbox-outgoing-filters.php";
// ----- ----- ----- ----- ----- 
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing.css">
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing-details.css">

<section>
    <div class="alert alert-warning my-3" role="alert">
        <strong>Внимание!</strong> Для удобства временно в текущей входящей и исходящей почте выведены записи прошлого
        года начиная с 01.07.2023
    </div>
...
; ?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing-modal-logCheckouts.css">
...
; ?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing-modal-logChanges.css">
...
; ?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing-modal-logComments.css">
...
; ?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing-modal-listAddFiles.css">
...
; ?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing-modal-listLinkDocs.css">
...
; ?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing-modal-listAdditionalLinkDocs.css">
