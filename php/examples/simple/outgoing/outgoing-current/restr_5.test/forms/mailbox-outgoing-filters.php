...
?>
<link rel="stylesheet"
      href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing-filters.css">
...
<p class="mail-outgoing-filters-button">
    ...
    <button class="btn btn-sm btn-outline-secondary" type="button" data-toggle="collapse"
            data-target="#mail-outgoing-filters-block" aria-expanded="false"
            aria-controls="mail-outgoing-filters-block">
        ...
        <div class="card card-body bg-light border-0 w-100">
            ...
            <div class="block d-flex flex-row">
                ...
                <div class="form-group w-25 mb-3 mx-1">
                    ...
                    <input type="text" id="filterNumber" class="form-control"
                           placeholder="Номер или часть номера документа" name="filterNumber" value="">
                </div>
                <!-- Блок -->
                <div class="form-group w-25 mb-3 mx-1">
                    <label for="filterKOD">ID документа</label>
                    <input type="text" class="form-control" id="filterKOD" name="filterKOD"
                           aria-describedby="filterKODHelp" placeholder="Целиком или часть ID документа" value="">
                </div>
                <!-- Блок -->
                <div class="form-group w-25 mb-3 mx-1">
                    <label for="filterSourceID">Входящий номер контрагента</label>
                    <input type="text" class="form-control" id="filterSourceID" name="filterSourceID"
                           aria-describedby="filterSourceIDHelp" placeholder="Часть входящего номера контрагента"
                           value="">
                </div>
            </div>
            <div class="block d-flex flex-row">
            ...
            <div class="block d-flex flex-row">
                ...
                <div class="form-group flex-fill mb-3 mx-1 w-25">
                    ...
                    <input type="text" id="filterAbout" class="form-control" placeholder="Что-нибудь из темы документа"
                           name="filterAbout" value="">
                </div>
                <!-- Блок -->
                <div class="form-group flex-fill mb-3 mx-1 w-25">
                    <label for="filterRecipient">Организация-получатель</label>
                    <input type="text" id="filterRecipient" class="form-control"
                           placeholder="Часть названия организации" name="filterRecipient" value="">
                </div>
            </div>
            <div class="block d-flex flex-row justify-content-end">
                <div class="form-group">
                    <button id="columnSearch_btnApply" type="button" class="btn btn-sm btn-outline-secondary">Применить
                        фильтры</button>
                    <button id="columnSearch_btnClear" type="button"
                            class="btn btn-sm btn-outline-secondary columnSearch_btnClear">Очистить</button>
                </div>
            </div>
        </div>
    </div>
