...
// :::
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing-customForm.css">
...
<div id="customForm-mail-main-outbox" class="editorform">
    <div id="editorform-editor-tabs" class="editorform-tabs w-100">
        <ul id="editorform-editor-tabs-menu" class="nav nav-tabs editorform-tabs-menu">
            ...
            <li class="nav-item tab8 tab-incoming-rel hide"><a class="nav-link" data-toggle="tab" href="#doc-editor-tab-8" title="">Ответное</a></li>
            <li class="nav-item tab2"><a class="nav-link" data-toggle="tab" href="#doc-editor-tab-2" title="">Файл</a>
            </li>
            <!-- <li class="nav-item tab3"><a class="nav-link" data-toggle="tab" href="#doc-editor-tab-3" title="">Исполнитель</a></li> -->
            <li class="nav-item tab6"><a class="nav-link" data-toggle="tab" href="#doc-editor-tab-6" title="">Исполнение</a></li>
            <!-- <li class="nav-item tab4"><a class="nav-link" data-toggle="tab" href="#doc-editor-tab-4" title="">Получатель</a></li> -->
        ...
        <div class="tab-content p-2">
                    ...
                    <div class="d-flex flex-column w-50">
                        ...
                        <div class="block d-flex flex-column">
                            <div class="block w-100">
                                <fieldset class="field w-100">
                                    <editor-field name="<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_docContractor_kodispolout">
                                    </editor-field>
                                </fieldset>
                            ...
                            <div class="block w-100">
                                <fieldset class="field w-100">
                                    <editor-field name="<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_docContractorComment">
                                    </editor-field>
                                </fieldset>
                                <fieldset class="field">
                        ...
                        <div class="block d-flex flex-column">
                            <div class="d-flex flex-column w-100">
                                <fieldset class="field docRecipient">
                                    <editor-field name="<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_docRecipient_kodzakaz">
                                    </editor-field>
                                </fieldset>
                            ...
                            <div class="d-flex flex-row w-100">
                                <fieldset class="field docSourceID w-50">
                                    <editor-field name="<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_docSourceID">
                                    </editor-field>
                                </fieldset>
                                <fieldset class="field docSourceDate w-50">
                ...
                <div class="section d-flex flex-column">
                    ...
                    <div id="docType2-section-rowID-main" class="block d-flex flex-column docType2-section-only">
                        <div class="block mb-1">
                            ...
                            <!-- -->
                            <div id="inbox-relExist-alert" class="alert alert-danger alert-fadein fade show small mx-3 mb-0 inbox-relExist-alert" style="display:none">
                                <div class="inbox-relExist-alert-msg"></div>
                            </div>
                            <!-- -->
                            <div id="inbox-setCheckout-alert" class="alert alert-warning alert-fadein fade show small mx-3 mb-0 inbox-setCheckout-alert" style="display:none">
                            ...
                            <!-- -->
                            <div class="w-100 mt-2 rowID-rel-only" style="display:none">
                                <div class="block d-flex">
                                    <fieldset class="field checkbox-inline w-100">
                            ...
                            <div id="inbox-rowID-rel-alert" class="alert alert-warning alert-fadein fade show small mx-3 mb-0 rowID-rel-only-alert" style="display:none">Если данный чекбокс установлен, то тип входящего письма (в поле
                                выше)
                        ...
                        <div class="block mb-1">
                            ...
                            <div id="inbox-rowIDadd-rel-alert" data-dte-e="msg-message" class="alert alert-warning alert-fadein fade show small mx-3 mb-0 rowID-rel-only-alert" style="display:none">Дополнительные входящие документы, на которые текущий документ
                    ...
                    <div id="docType2-section-rowID-add" class="block d-flex flex-column docType2-section-only">
                        ...
                        <div id="inbox-rowIDadd-dopmsg-rel-alert" data-dte-e="msg-message" class="alert alert-warning alert-fadein fade show small mx-3 my-1 rowID-rel-only-alert" style="display:none">В текущей версии после сохранения статус исполнения по документам в
                            этом списке входящих никак не изменится. Просто в них будет текущий документ отмечен как
                            ответный. Если эти документы должны быть отмечены как исполненные (если они таковыми еще не
                            являются), то это придется сделать вручную по каждому из них в
                            разделе Входящие.</div>
                    </div>
                </div>
            </div>
            <!-- 
            ...
            <div id="doc-editor-tab-2" class="tab-pane fade">
                <div class="section d-flex flex-column">
                    ...
                    <p class="small text-right mb-0" style="color:#AAAAAA; font-size:0.7rem; margin: 5px 20px"><span class="px-1 text-dark"><sup><i class="fa-solid fa-star-of-life fa-xs"></i></sup></span>В
                ...
                <div class="section d-flex flex-column">
                    ...
                    <div class="block d-flex flex-row">
                        <div class="block d-flex flex-column w-50">
                            ...
                            <fieldset class="field checkbox-inline">
                                <editor-field name="<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_controlIspolUseDeadline">
                                </editor-field>
                            </fieldset>
                    ...
                    <div class="block d-flex flex-row">
                        <div class="block d-flex flex-column w-100">
                            <fieldset class="field checkbox-inline ispolStatus-visible">
                                <editor-field name="<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_controlIspolCheckoutComment">
                                </editor-field>
                            </fieldset>
                        </div>
                    </div>
                ...
                <div class="section d-flex flex-column">
                    <div class="block d-flex flex-row">
                        <div class="block d-flex flex-column w-50">
                            ...
                            <fieldset class="field checkbox-inline">
                                <editor-field name="<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_controlIspolMailReminder1">
                                </editor-field>
                            </fieldset>
                            <fieldset class="field checkbox-inline">
                                <editor-field name="<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_controlIspolMailReminder2">
                                </editor-field>
                            </fieldset>
                            <fieldset class="field checkbox-inline">
                                <editor-field name="<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_controlIspolMailNotifyDL">
                                </editor-field>
                            </fieldset>
                            <fieldset class="field checkbox-inline">
                                <editor-field name="<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_controlIspolMailNotifyCheckout">
                                </editor-field>
                            </fieldset>
                        ...
                        <div class="block d-flex flex-column w-50">
                            ...
                            <fieldset class="field checkbox-inline">
                                <editor-field name="<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_controlIspolMailSpecialNotifyCheckout <span class='text-danger'>Скоро</span>">
                                </editor-field>
                            </fieldset>
                            <fieldset class="field checkbox-inline">
                                <editor-field name="<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_controlIspolMailSpecialNotifyDL <span class='text-danger'>Скоро</span>">
                                </editor-field>
                            </fieldset>
                        </div>
                    </div>
