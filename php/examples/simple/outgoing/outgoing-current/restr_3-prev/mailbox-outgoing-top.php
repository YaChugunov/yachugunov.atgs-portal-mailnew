...
?>
        ...
        <button class="btn btn-sm btn-outline-secondary" type="button" data-toggle="collapse" data-target="#mail-outgoing-deck-block" aria-expanded="false" aria-controls="mail-outgoing-deck-block">
            ...
            <div id="mail-outgoing-deck-block" class="collapse show w-100">
                    ...
                    <div class="card border-danger mb-3">
                        <div class="card-header text-white bg-danger">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div data-toggle="popover" data-content='<p>Если вы видите эту пульсируюущую иконку, это означает, что установлен чекбокс <u>Показывать только документы, где я исполнитель</u> и статистическая информация в этом блоке относится только к Вам как исполнителю.</p>' class="ml-auto"><i style="color:#fff !important" class="fa-solid fa-circle-user fa-beat fa-xl"></i></div>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="outStats d-flex flex-column">
                                <div class="outStats-DL3days d-flex flex-row justify-content-between">
                                    <div class="filterLinked" filterID="filterIspolDL" filterVal="less3" data-toggle="popover" data-content='<h3 class="text-danger">Комбинированный фильтр</h3><p>В блоке фильтров будет выставлено 3 фильтра: <u>дедлайн</u> (менее 3-х дней), <u>контроль исполнения</u> (только на контроле), <u>исполнение</u> (не исполнен).</p>'>
                                ...
                                <div class="outStats-DL1day d-flex flex-row justify-content-between">
                                    <div class="filterLinked" filterID="filterIspolDL" filterVal="less1" data-toggle="popover" data-content='<h3 class="text-danger">Комбинированный фильтр</h3><p>В блоке фильтров будет выставлено 3 фильтра: <u>дедлайн</u> (менее суток), <u>контроль исполнения</u> (только на контроле), <u>исполнение</u> (не исполнен).</p>'>
                                ...
                                <div class="outStats-DLexpired d-flex flex-row justify-content-between">
                                    <div class="filterLinked" filterID="filterIspolDL" filterVal="expired" data-toggle="popover" data-content='<h3 class="text-danger">Комбинированный фильтр</h3><p>В блоке фильтров будет выставлено 3 фильтра: <u>дедлайн</u> (срок истёк), <u>контроль исполнения</u> (только на контроле), <u>исполнение</u> (не исполнен).</p>'>
                        ...
                        <div class="card-body">
                            ...
                            <div class="outStats d-flex flex-column">
                                <div class="outStats-noispol d-flex flex-row justify-content-between">
                                    <div class="filterLinked" filterID="filterIspol" filterVal="---" data-toggle="popover" data-content='<h3 class="text-warning">Обычный фильтр</h3><p>В блоке фильтров будет выставлен фильтр <u>ответственный</u> в значение "---", которое означет отсутствие ответственного.</p>'>
                                ...
                                <div class="outStats-CTRLnotexec d-flex flex-row justify-content-between">
                                    <div class="filterLinked" filterID="filterCheckout" filterVal="0" data-toggle="popover" data-content='<h3 class="text-warning">Комбинированный фильтр</h3><p>В блоке фильтров будет выставлено 2 фильтра: <u>контроль исполнения</u> (только на контроле), <u>исполнение</u> (не исполнен).</p>'>
                        ...
                        <div class="card-body text-dark">
                            ...
                            <div class="outStats d-flex flex-column">
                                ...
                                <div class="outStats-CTRLon d-flex flex-row justify-content-between">
                                    <div class="filterLinked" filterID="filterInControl" filterVal="1" data-toggle="popover" data-content='<h3 class="text-success">Обычный фильтр</h3><p>В блоке фильтров будет выставлен фильтр контроль исполнения (активен).</p>'>
                                ...
                                <div class="outStats-DLon d-flex flex-row justify-content-between">
                                    <div class="filterLinked" filterID="filterIspolDL" filterVal="more3" data-toggle="popover" data-content='<h3 class="text-success">Комбинированный фильтр</h3><p>В блоке фильтров будет выставлено 3 фильтра: <u>дедлайн</u> (более 3-х суток), <u>контроль исполнения</u> (только на контроле), <u>исполнение</u> (не исполнен).</p>'>
                ...
                <p class="small text-right mb-0" style="color:#AAAAAA; font-size:0.7rem"><span class="px-1 text-dark"><sup><i class="fa-solid fa-star-of-life fa-xs"></i></sup></span>Вывод блока с информационными карточками
                    можно
                    скрыть/показать в разделе Настройки.</p>
                <p class="small text-right mb-0" style="color:#AAAAAA; font-size:0.7rem"><span class="px-1 text-dark"><sup><i class="fa-solid fa-star-of-life fa-xs"></i><i class="fa-solid fa-star-of-life fa-xs"></i></sup></span>Раздел будет пополняться новой статистической
