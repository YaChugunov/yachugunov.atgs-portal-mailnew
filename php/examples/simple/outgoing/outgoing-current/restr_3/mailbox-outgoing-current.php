...
<script type="text/javascript" language="javascript" class="init">
    ...
    function ajaxRequest_checkInUseDocStateDataAsync(action, koddocmail) {
        ...
        $.ajax({
            ...
            cache: false,
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-checkInUseDocState.php',
            data: {
                action: action,
                koddocmail: koddocmail
            },
    ...
    $(document).ready(function() {
        ...
        $('#columnSearch_btnClear, button.columnSearch_btnClear').on('click', function() {
            ...
            var ispolStatus =
                '<?php echo isset($_QRY_ISPOL["status_ispolout"]) ? $_QRY_ISPOL["status_ispolout"] : ""; ?>';
            var showIspolOutOnly =
                '<?php echo isset($_QRY_ISPOL["showispoloutonly"]) ? $_QRY_ISPOL["showispoloutonly"] : ""; ?>';
