...
Editor::inst($db, __MAIL_OUTGOING_PREFIX . '_logCheckouts')
	->fields(
		Field::inst(__MAIL_OUTGOING_PREFIX . '_logCheckouts.id'),
		Field::inst(__MAIL_OUTGOING_PREFIX . '_logCheckouts.timestamp')
			->getFormatter(Format::datetime(
				'Y-m-d H:i:s',
				'd.m.Y H:i:s'
			)),
		Field::inst(__MAIL_OUTGOING_PREFIX . '_logCheckouts.koddocmail'),
		Field::inst(__MAIL_OUTGOING_PREFIX . '_logCheckouts.userid'),
		Field::inst(__MAIL_OUTGOING_PREFIX . '_logCheckouts.kodispol'),
		Field::inst(__MAIL_OUTGOING_PREFIX . '_logCheckouts.ispolStatus'),

		Field::inst('mailbox_sp_users.namezayvtel'),
		Field::inst('mailbox_sp_users.namezayvfio')
	)

	->where(__MAIL_OUTGOING_PREFIX . '_logCheckouts.koddocmail', $_POST['koddocmail'], '=')
	->leftJoin('mailbox_sp_users', 'mailbox_sp_users.ID', '=', __MAIL_OUTGOING_PREFIX . '_logCheckouts.userid')
