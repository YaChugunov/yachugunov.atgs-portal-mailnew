...
<script type="text/javascript" language="javascript" class="init">
    ...
    function ajaxRequest_listAttachedFiles(koddocmail, responseHandler) {
        ...
        request_listAttachedFiles = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-listAttachedFiles.php',
            cache: false,
            data: {
    ...
    function ajaxRequest_getLastDeadlineMail(koddocmail, userid, responseHandler) {
        ...
        request_getLastDeadlineMail = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getLastDeadlineMail.php',
            cache: false,
            data: {
                koddocmail: koddocmail,
                userid: userid
    ...
    function ajaxRequest_getLastNotify(action, koddocmail, parameter, responseHandler) {
        ...
        request_getLastNotify = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getLastNotify.php',
            cache: false,
            data: {
                koddocmail: koddocmail,
                parameter: parameter,
    ...
    function ajaxRequest_getLastAction(koddocmail, parameter, responseHandler) {
        ...
        request_getLastAction = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getLastAction.php',
            cache: false,
            data: {
                koddocmail: koddocmail,
                parameter: parameter
    ...
    function ajaxRequest_getLinkedRelFiles(koddocmail, responseHandler) {
        ...
        request_getLinkedRelFiles = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getLinkedRelFiles.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_countDocComments(koddocmail, responseHandler) {
        ...
        request_countDocComments = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-countDocComments.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_checkOnCurrYearAsync(koddocmail) {
        ...
        $.ajax({
            ...
            cache: false,
            type: "post",
            url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-checkRecordOnCurrentYear.php",
            data: {
                koddocmail: koddocmail
            },
    ...
    $(document).ready(function() {
        ...
        table_outgoing = $('#outbox').DataTable({
            ...
            language: {
                url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/dt_russian-mail.json"
            },
            ajax: {
                url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-outgoing-process.php",
                type: "POST"
            },
            serverSide: true,
        ...
        $(document).on("click", "div#link-logCheckouts", function() {
            ...
            $('#table-logCheckouts').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-outgoing-process-showLogCheckouts.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-logChanges", function() {
            ...
            $('#table-logChanges').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-outgoing-process-showLogChanges.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-logComments", function() {
            ...
            */
            ...
            editor_logComments = new $.fn.dataTable.Editor({
                display: "bootstrap",
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-outgoing-process-showLogComments.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-listAddFiles", function() {
            ...
            */
            ...
            editor_listAddFiles = new $.fn.dataTable.Editor({
                display: "bootstrap",
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-outgoing-process-showLogAddFiles.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-listLinkDocs", function() {
            ...
            */
            ...
            table_listLinkDocs = $('#table-listLinkDocs').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-outgoing-process-showLogLinkDocs.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
            ...
            */
            var table_listAdditionalLinkDocsDog = $('#table-listAdditionalLinkDocsDog').dataTable({
                dom: "<'row'<'col-sm-5'><'col-sm-4'><'col-sm-3'>>" +
                    "<'row'<'col-sm-12't>>" + "<'row'<'col-sm-8'><'col-sm-4'>>",
                language: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/dt_russian-docDogLinks.json"
                },
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-outgoing-process-showLogAdditionalLinkDocsDog.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
            ...
            var table_listAdditionalLinkDocsMOut = $('#table-listAdditionalLinkDocsMOut').dataTable({
                dom: "<'row'<'col-sm-5'><'col-sm-4'><'col-sm-3'>>" +
                    "<'row'<'col-sm-12't>>" + "<'row'<'col-sm-8'><'col-sm-4'>>",
                language: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/dt_russian-docMailLinks.json"
                },
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-outgoing-process-showLogAdditionalLinkDocsMOut.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
            ...
            var table_listAdditionalLinkDocsMInc = $('#table-listAdditionalLinkDocsMInc').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-outgoing-process-showLogAdditionalLinkDocsMInc.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
...
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/css/common-modals.css">
<?php
// ----- ----- ----- ----- -----
// Подключаем форму и выводим таблицу входящей почты
// :::
include __DIR_ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3 . "/forms/mailbox-outgoing-filters.php";
// ----- ----- ----- ----- -----
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-outgoing.css">
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-outgoing-details.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-outgoing-modal-logCheckouts.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-outgoing-modal-logChanges.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-outgoing-modal-logComments.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-outgoing-modal-listAddFiles.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-outgoing-modal-listLinkDocs.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-outgoing-modal-listAdditionalLinkDocs.css">
