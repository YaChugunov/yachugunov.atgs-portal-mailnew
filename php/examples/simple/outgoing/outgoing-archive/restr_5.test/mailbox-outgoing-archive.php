...
<script type="text/javascript" language="javascript" class="init">
    ...
    function ajaxRequest_listAttachedFiles(koddocmail, responseHandler) {
        ...
        request_listAttachedFiles = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-listAttachedFiles.php',
            cache: false,
            data: {
    ...
    function ajaxRequest_getLastDeadlineMail(koddocmail, userid, responseHandler) {
        ...
        request_getLastDeadlineMail = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getLastDeadlineMail.php',
            cache: false,
            data: {
                koddocmail: koddocmail,
                userid: userid
    ...
    function ajaxRequest_getLastNotify(action, koddocmail, parameter, responseHandler) {
        ...
        request_getLastNotify = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getLastNotify.php',
            cache: false,
            data: {
                koddocmail: koddocmail,
                parameter: parameter,
    ...
    function ajaxRequest_getLastAction(koddocmail, parameter, responseHandler) {
        ...
        request_getLastAction = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getLastAction.php',
            cache: false,
            data: {
                koddocmail: koddocmail,
                parameter: parameter
    ...
    function ajaxRequest_getLinkedRelFiles(koddocmail, responseHandler) {
        ...
        request_getLinkedRelFiles = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-getLinkedRelFiles.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_countDocComments(koddocmail, responseHandler) {
        ...
        request_countDocComments = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-countDocComments.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_checkOnCurrYearAsync(koddocmail) {
        ...
        $.ajax({
            ...
            cache: false,
            type: "post",
            url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxOutgoing-checkRecordOnCurrentYear.php",
            data: {
                koddocmail: koddocmail
            },
    ...
    $(document).ready(function() {
        ...
        table_outgoing = $('#outbox').DataTable({
            ...
            language: {
                url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/dt_russian-mail.json"
            },
            ajax: {
                url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process.php",
                type: "POST"
            },
            serverSide: true,
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        if (data != null && row.<?php echo __MAIL_OUTGOING_TABLENAME; ?>
                            ...
                            return '<div class=""><span data-toggle="tooltip" title="Номер документа, связанный с текущим как ответный, либо являющийся запросом для текущего. При клике вы перейдете к этому документу в разделе входящих." class=""><a class="text-dark" href="<?php echo __ROOT . __SERVICENAME_MAILNEW; ?>/index.php?type=in&mode=archive&rel=' +
                                row.<?php echo __MAIL_OUTGOING_TABLENAME; ?>
        ...
        $('#outbox tbody').on('click', 'tr td.details-control', function() {
            ...
            if (row.child.isShown()) {
                ...
                d.mainfile = docFileID != "" && docFileID != null ?
                    ...
                    'Файл не прикреплен';
                //
                d.recipientName = d.<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_docRecipient !== "" ? d
                    .<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_docRecipient : "---";
                d.ispolActive = d.<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_controlIspolActive == 1 ?
                ...
                d.reminder1 = d.<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_controlIspolMailReminder1 ==
                    1 ?
                    '<span class="" style=""><i class="fa-regular fa-square-check"></i></span>' :
                    '<span class="" style=""><i class="fa-regular fa-square"></i></span>';
                d.reminder2 = d.<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_controlIspolMailReminder2 ==
                    1 ?
                    '<span class="" style=""><i class="fa-regular fa-square-check"></i></span>' :
                    '<span class="" style=""><i class="fa-regular fa-square"></i></span>';
                d.ispolCheckout = d.<?php echo __MAIL_OUTGOING_TABLENAME; ?>.outbox_controlIspolCheckout ==
                    1 ?
                    '<span class="" style=""><i class="fa-regular fa-square-check"></i></span>' :
                    '<span class="" style=""><i class="fa-regular fa-square"></i></span>';
        ...
        $('#columnSearch_btnClear, button.columnSearch_btnClear').on('click', function() {
            ...
            $('#filterDept').val('');
            $('#filterRecipient').val('');
            if ($("#chkOnlyIspolMe").prop('checked') === false) {
                $('#filterIspol').val('');
                table_outgoing
                    .columns()
                    .search('')
        ...
        $(document).on("click", "div#link-logCheckouts", function() {
            ...
            $('#table-logCheckouts').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogCheckouts.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-logChanges", function() {
            ...
            $('#table-logChanges').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogChanges.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, row, meta) {
                        let action = row
                            .<?php echo __MAIL_OUTGOING_PREFIX; ?>_logChanges.action;
                        switch (action) {
                            case "COMM-CRT":
                                pref =
                        ...
                        if (data != "" && data != null) {
                            ...
                            for (i = 0; i < x.length; i++) {
                                changeRow += x[i] + ((x.length > 1 && i < (x.length -
                                        1)) ?
        ...
        $(document).on("click", "div#link-logComments", function() {
            ...
            */
            ...
            editor_logComments = new $.fn.dataTable.Editor({
                display: "bootstrap",
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogComments.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-listAddFiles", function() {
            ...
            */
            ...
            editor_listAddFiles = new $.fn.dataTable.Editor({
                display: "bootstrap",
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogAddFiles.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-listLinkDocs", function() {
            ...
            */
            ...
            table_listLinkDocs = $('#table-listLinkDocs').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogLinkDocs.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, row, meta) {
                        if (data != null) {
                            return '<span class="link"><a href="incoming-related.php?mode=related&record_id=' +
                                row.<?php echo __MAIL_INCOMING_TABLENAME; ?>.ID + '">' +
                                data + '</a></span>';
                        } else {
            ...
            */
            var table_listAdditionalLinkDocsDog = $('#table-listAdditionalLinkDocsDog').dataTable({
                dom: "<'row'<'col-sm-5'><'col-sm-4'><'col-sm-3'>>" +
                    "<'row'<'col-sm-12't>>" + "<'row'<'col-sm-8'><'col-sm-4'>>",
                language: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/dt_russian-docDogLinks.json"
                },
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogAdditionalLinkDocsDog.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
            ...
            var table_listAdditionalLinkDocsMOut = $('#table-listAdditionalLinkDocsMOut').dataTable({
                dom: "<'row'<'col-sm-5'><'col-sm-4'><'col-sm-3'>>" +
                    "<'row'<'col-sm-12't>>" + "<'row'<'col-sm-8'><'col-sm-4'>>",
                language: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/dt_russian-docMailLinks.json"
                },
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogAdditionalLinkDocsMOut.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
                    ...
                    render: function(data, type, row, meta) {
                        if (data != null) {
                            return '<span class="link"><a href="<?php echo __ROOT . __SERVICENAME_MAILNEW; ?>/outgoing-related.php?mode=related&record_id=' +
                                row.<?php echo __MAIL_OUTGOING_TABLENAME; ?>.ID + '">' +
                                data + '</a></span>';
                        } else {
                            return '<span class="glyphicon glyphicon-option-horizontal"></span>';
                        }
            ...
            var table_listAdditionalLinkDocsMInc = $('#table-listAdditionalLinkDocsMInc').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-outgoing-process-showLogAdditionalLinkDocsMInc.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
...
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/common-modals.css">
<?php
// ----- ----- ----- ----- -----
// Подключаем форму и выводим таблицу входящей почты
// :::
include __DIR_ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5 . "/forms/mailbox-outgoing-filters.php";
// ----- ----- ----- ----- -----
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing.css">
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing-details.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing-modal-logCheckouts.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing-modal-logChanges.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing-modal-logComments.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing-modal-listAddFiles.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing-modal-listLinkDocs.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_OUTGOING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-outgoing-modal-listAdditionalLinkDocs.css">
