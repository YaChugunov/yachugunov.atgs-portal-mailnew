...
if (isset($_SESSION['password']) && isset($_SESSION['login'])) {
	if (checkUserAuthorization($_SESSION['login'], $_SESSION['password']) == -1) {
		...
		if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && !empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest' && $userID != "") {
			...
			$outgoing_kodRecipientOrgDefault_loadFromDB = isset($_req_loadFromDB['outgoing_kodRecipientOrgDefault']) ? $_req_loadFromDB['outgoing_kodRecipientOrgDefault'] : 0;
