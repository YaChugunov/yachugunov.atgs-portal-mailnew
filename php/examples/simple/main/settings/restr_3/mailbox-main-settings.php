...
<script type="text/javascript" language="javascript" class="">
    ...
    function ajaxRequest_loadSettingsData(action, userID, responseHandler) {
        ...
        var outgoing_setDeadlineOnStart = $('input[data-fieldname="outgoing_setDeadlineOnStart"]').is(':checked') ?
            1 : 0;
        var use_lightTheme = $('input[data-fieldname="use_lightTheme"]').is(':checked') ? 1 : 0;
        ...
        request_loadSettingsData.done(function(response, textStatus, jqXHR) {
            ...
            if (response != "-1" && response != "-2" && response != "0") {
                ...
                if (use_lightTheme == 1) {
                    if (!$('input[data-fieldname="use_lightTheme"]').is(':checked')) {
                        $('#use_lightTheme').prop('checked', true);
                    }
                } else {
                    if ($('input[data-fieldname="use_lightTheme"]').is(':checked')) {
                        $('#use_lightTheme').prop('checked', false);
                    }
                }
    ...
    <div id="mail-settings-center-block" class="w-100">
        ...
        <ul class="nav nav-pills bg-transparent border border-grey text-dark rounded-lg px-3 py-3 mb-5" role="tablist">
            ...
            <li class="nav-item custom-pill ml-auto">
                <span id="uploadSettings-spinner" class="spinner-border spinner-border-sm text-danger mr-1" role="status" style="position:relative; top:0.1rem">
        ...
        <div class="tab-content d-flex flex-column">
            <div class="tab-pane container active" id="settings-common" role="tabpanel" aria-labelledby="settings-common-tab" style="min-height:480px">
                <div class="row">
                    <h4 class="text-info mb-3 w-100">Интерфейс</h4>
                    <div class="col">
                        <div class="col-12">
                            <div class="align-items-center custom-control custom-switch mb-3">
                                <input type="checkbox" class="custom-control-input" id="use_lightTheme" data-fieldname="use_lightTheme">
                                <label class="custom-control-label" for="use_lightTheme">Светлая тема (после сохранения
                                    настроек надо перегрузить страницу)</label>
                            </div>
                        </div>

                        <div class="col-12">
                            <div class="align-items-center custom-control custom-switch mb-3">
                                <input type="checkbox" class="custom-control-input" id="mailbox_showLegend" data-fieldname="mailbox_showLegend">
            ...
            <div class="tab-pane container" id="settings-incoming" role="tabpanel" aria-labelledby="settings-incoming-tab" style="min-height:480px">
                <div class="row mb-5">
                    <h4 class="text-info mb-3 w-100">Интерфейс</h4>
                    <div class="col">
                        <div class="col-12">
                            <div class="align-items-center custom-control custom-switch mb-3">
                                <input type="checkbox" class="custom-control-input" id="incoming_showDashboard" data-fieldname="incoming_showDashboard">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="col-12">
                            <div class="align-items-center custom-control custom-switch mb-3">
                                <input type="checkbox" class="custom-control-input" value="" id="incoming_setControlIspolOnStart" data-fieldname="incoming_setControlIspolOnStart">
                        ...
                        <div class="col-12">
                            <div class="align-items-center custom-control custom-switch mb-3">
                                <input type="checkbox" class="custom-control-input" value="" id="incoming_setDeadlineOnStart" data-fieldname="incoming_setDeadlineOnStart">
            ...
            <div class="tab-pane container" id="settings-outgoing" role="tabpanel" aria-labelledby="settings-outgoing-tab" style="min-height:480px">
                <div class="row mb-5">
                    <h4 class="text-info mb-3 w-100">Интерфейс</h4>
                    <div class="col-12">
                        <div class="col">
                            <div class="align-items-center custom-control custom-switch mb-3">
                                <input type="checkbox" class="custom-control-input" id="outgoing_showDashboard" data-fieldname="outgoing_showDashboard">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col">
                        <div class="col-12">
                            <div class="align-items-center custom-control custom-switch mb-3">
                                <input type="checkbox" class="custom-control-input" value="" id="outgoing_setControlIspolOnStart" data-fieldname="outgoing_setControlIspolOnStart">
                        ...
                        <div class="col-12">
                            <div class="align-items-center custom-control custom-switch mb-3">
                                <input type="checkbox" class="custom-control-input" value="" id="outgoing_setDeadlineOnStart" data-fieldname="outgoing_setDeadlineOnStart">
                ...
                <div class="row">
                    <h4 class="text-info mb-3 w-100">Предустановки "по умолчанию" для быстрого создания исходящего
                        письма<span data-toggle="popover" data-content="<p>Настройки ниже являются обязательными при создании исходящего документа. Установив эти настройки заранее вы сможете создавать его в два клика зарезервировав номер, а потом уже внести необходимые изменения.</p>"><sup><i class="fa-solid fa-exclamation-circle fa-xs pl-1 text-danger"></i></sup></span></h4>
                    <div class="col-4">
                        <div class="align-items-center mb-3">
                            <label class="" for="selRecipientOrg"><b>Организация-получатель по
                                    умолчанию</b></label>
                            <select class="form-control" id="selRecipientOrg" data-fieldname="outgoing_kodRecipientOrgDefault">
                                <?php
                    ...
                    <div class="col-12 my-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="textAbout" data-fieldname="outgoing_textAboutDefault" type="text" placeholder="Описание исходящего письма 'по умолчанию'">
                        </div>
            ...
            <div class="tab-pane container" id="settings-feedback" role="tabpanel" aria-labelledby="settings-feedback-tab" style="min-height:480px">
                <div class="row">
                    <h4 class="text-info mb-3 w-100">Управление уведомлениями и подписками на рассылки</h4>
                    <div class="col-12">
                        <div class="col">
                            <div class="align-items-center custom-control custom-switch mb-3">
                                <input type="checkbox" class="custom-control-input" id="use_pushMessages" data-fieldname="use_pushMessages">
                    ...
                    <div class="col-12">
                        <div class="col">
                            <div class="align-items-center custom-control custom-switch mb-3">
                                <input type="checkbox" class="custom-control-input" value="" id="incoming_subscribeWeekReminder" data-fieldname="incoming_subscribeWeekReminder">
                                <label class="custom-control-label" for="incoming_subscribeWeekReminder">
                                    ...
                                    <span data-toggle="popover" data-content="<p>Для проверки берутся документы на старше <u>одного месяца</u>. Не каждый документ, попадающий в этот список, действительно является не исполненным. Возможно просто ответственный не поставил отметку об исполнении.</p>"><sup><i class="fa-solid fa-exclamation-circle fa-xs text-danger"></i></sup></span></label>
                            </div>
                        </div>
                    </div>
                </div>
