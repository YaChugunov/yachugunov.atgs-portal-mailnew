...
function ajaxRequest_loadSettingsData(action, userID, responseHandler) {
    ...
    request_loadSettingsData = $.ajax({
        url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_MAIN_SETTINGS_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxSettings-loadSettingsData.php',
        type: "post",
        cache: false,
        data: {
            action: action,
...
function ajaxRequest_parameterSaveToDB(responseHandler, objectID) {
    ...
    request_settingsUI = $.ajax({
        url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_MAIN_SETTINGS_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxSettings-parameterSaveToDB.php',
        type: "post",
        cache: false,
        data: {
            userID: userID,
...
function ajaxRequest_settingsLoadFromDB(responseHandler) {
    ...
    request_showIspolOnly = $.ajax({
        url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_MAIN_SETTINGS_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxSettings-settingsLoadFromDB.php',
        type: "post",
        cache: false,
        data: {
            userID: _userid
                    ...
                    <div class="col">
                        <div class="col-12">
                            <div class="align-items-center custom-control custom-switch mb-3">
                                <input type="checkbox" class="custom-control-input" id="use_lightTheme"
                                       data-fieldname="use_lightTheme">
