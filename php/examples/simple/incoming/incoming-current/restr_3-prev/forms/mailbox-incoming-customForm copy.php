...
// :::
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-incoming-editorform.css">
<link href="<?php echo __ROOT . __SERVICENAME_MAILNEW; ?>/_assets/libs/Other/Bootstrap-fileinput/css/fileinput.min.css" rel="stylesheet" />
...
<div id="editorform">
    <div id="editorform-editor-tabs" style="width:100%">
        <ul id="editorform-editor-tabs-menu" class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#doc-editor-tab-1" title=""><span id="doc-editor-menu-tab-1-errmsg"></span>Регистрация</a></li>
            <li><a data-toggle="tab" href="#doc-editor-tab-2" title=""><span id="doc-editor-menu-tab-2-errmsg"></span>Файл</a>
            </li>
            <li><a data-toggle="tab" href="#doc-editor-tab-3" title=""><span id="doc-editor-menu-tab-3-errmsg"></span>Ответственный</a></li>
            <li><a data-toggle="tab" href="#doc-editor-tab-6" title=""><span id="doc-editor-menu-tab-6-errmsg"></span>Исполнение</a></li>
            <li><a data-toggle="tab" href="#doc-editor-tab-4" title=""><span id="doc-editor-menu-tab-4-errmsg"></span>Отправитель</a></li>
            <li><a data-toggle="tab" href="#doc-editor-tab-5" title=""><span id="doc-editor-menu-tab-5-errmsg"></span>Дополнительно</a></li>
            <li><a data-toggle="tab" href="#doc-editor-tab-7" title=""><span id="doc-editor-menu-tab-7-errmsg"></span>Связи</a></li>
        </ul>
        <div class="tab-content" style="padding:5px">
            <div class="popoverDivControl checkbox" style="">
                <label>
                    <input id="popoverCheckboxEnable" type="checkbox" value="">
                    <div>Включить/отключить всплывающие подсказки для некоторых элементов формы<sup style='color:red; padding:0 3px'><i class='fa fa-exclamation-circle' aria-hidden='true'></i></sup>
                    </div>
                </label>
            </div>
                ...
                <div class="Section">
                    ...
                    <div class="Block100 docType2-section-only">
                        ...
                        <div class="Block100" style="margin-bottom:15px">
                            ...
                            <div class="Block100 fieldset-table-row rowID-rel-only" style="padding:0; margin-top:-20px">
                                ...
                                <div class="fieldset-table-cell" style="width:100%">
                                    <div>
                                        <div class="chekbox-inline-text text-danger" style="font-family:'Play',sans-serif; font-style:normal; font-weight:normal; font-size:1em">
                            ...
                            <div id="outbox_rowID_rel-message" class="rowID-rel-only" data-dte-e="msg-message" style="display:block; margin-top:-15px; margin-left:15px; margin-right:15px; line-height:1.2em; padding-left:28px;">
                        ...
                        <div class="Block100" style="padding-left:15px; padding-right:15px">
                            <div class="Block100 fieldset-table-row" style="color:#FAFAFA; background-color:#02546E; margin-bottom:5px; padding:0">
                            ...
                            <div id="outbox_rowIDadd_rel-message" data-dte-e="msg-message"><span class="glyphicon glyphicon-exclamation-sign" style="padding-right:5px"></span>Имейте в виду, снятие
                    ...
                    <div class="Block100 docType2-section-only">
                        <div class="Block100 rowIDadd-enbl">
                            ...
                            <fieldset class="field100" style="padding:0 15px 5px">
                                <button id="mailbox-rel-links-btnAdd" class="btn btn-xs btn-primary doc-links-buttons">Добавить</button>
                                <button id="mailbox-rel-links-btnRemove" class="btn btn-xs btn-danger doc-links-buttons">Удалить</button>
                            </fieldset>
                        </div>
                        <div class="Block100 rowIDadd-enbl">
                ...
                <div class="Section">
                    <div class="Block100">
                        ...
                        <div class="Block40">
                            ...
                            <div class="Block100" style="min-height:137px; border:1px #ccc solid; border-radius:4px; padding:2px 4px; font-size:1.0em">
            ...
            <div id="doc-editor-tab-6" class="tab-pane fade in">
                <div class="Section">
                    <div class="Block100">
                        ...
                        <div class="Block60">
                            <div class="Block100 fieldset-table-row" style="background-color: #F1F1F1; margin-bottom: 5px;">
                        ...
                        <div class="Block40">
                            ...
                            <div class="Block100" style="border: 1px #02546e dashed; border-radius: 5px; margin-bottom: 5px;">
                                <div class="Block100 fieldset-table-row">
                                    <div class="fieldset-table-cell" style="padding-bottom:3px">
                                        <fieldset>
                            ...
                            <div class="Block100" style="border: 1px #02546e dashed; border-radius: 5px; margin-bottom: 5px; padding: 5px 0;">
                                <div class="Block100 fieldset-table-row">
                                    <div class="fieldset-table-cell" style="padding-bottom:3px">
                                        <fieldset>
                    ...
                    <div class="tab-content">
                        <div id="pill-incoming-tab" class="tab-pane fade in active">
                            <div class="Block100" style="margin-bottom: 20px">
                                ...
                                <div class="Block100">
                                    <fieldset class="field100" style="padding:0 15px 5px">
                                        <button id="inbox-doc-links-btnAdd" class="btn btn-xs btn-primary doc-links-buttons">Добавить</button>
                                        <button id="inbox-doc-links-btnRemove" class="btn btn-xs btn-primary doc-links-buttons">Удалить
                                            связь</button>
                                    </fieldset>
                                </div>
                                <div class="Block100">
                        ...
                        <div id="pill-outgoing-tab" class="tab-pane fade">
                            <div class="Block100" style="margin-bottom: 20px">
                                ...
                                <div class="Block100">
                                    <fieldset class="field100" style="padding:0 15px 5px">
                                        <button id="outbox-doc-links-btnAdd" class="btn btn-xs btn-primary doc-links-buttons">Добавить</button>
                                        <button id="outbox-doc-links-btnRemove" class="btn btn-xs btn-primary doc-links-buttons">Удалить
                                            связь</button>
                                    </fieldset>
                                </div>
                                <div class="Block100">
                        ...
                        <div id="pill-dognet-tab" class="tab-pane fade">
                            <div class="Block100" style="margin-bottom: 20px">
                                ...
                                <div class="Block100">
                                    <fieldset class="field100" style="padding:0 15px 5px">
                                        <button id="dognet-doc-links-btnAdd" class="btn btn-xs btn-primary doc-links-buttons">Добавить</button>
                                        <button id="dognet-doc-links-btnRemove" class="btn btn-xs btn-primary doc-links-buttons">Удалить
                                            связь</button>
                                    </fieldset>
                                </div>
                                <div class="Block100">
