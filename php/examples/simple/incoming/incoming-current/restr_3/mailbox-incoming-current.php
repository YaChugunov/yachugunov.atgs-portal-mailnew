...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        editor_incoming.on('open', function(e, mode, action) {
            ...
            // console.log("CHECK >>> .on(open) inbox_controlIspolActive", editor_incoming.field('<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_controlIspolActive').val());
            if (editor_incoming.field(
                    '<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_controlIspolActive')
                .val() == "1") {
                editor_incoming.field('ispolStatus').enable();
        ...
        if (editor_incoming.field('<?php echo __MAIL_INCOMING_TABLENAME; ?>.outbox_rowID_rel').val() == null ||
        ...
        table_incoming = $('#inbox').DataTable({
            ...
            createdRow: function(row, data, index) {
                ...
                //
                // console.log('checkVal(relRowID)', checkVal(relRowID), 'checkVal(relRowIDadd)', checkVal(relRowIDadd), 'ctrlActive', ctrlActive, 'ctrlCheckout', ctrlCheckout);
                if (docType == 3) {
        ...
        $('#columnSearch_btnClear, button.columnSearch_btnClear').on('click', function() {
            ...
            //
            var ispolname =
                '<?php echo isset($_QRY_ISPOL["namezayvfio"]) ? $_QRY_ISPOL["namezayvfio"] : ""; ?>';
            var ispolStatus =
                '<?php echo isset($_QRY_ISPOL["status_ispol"]) ? $_QRY_ISPOL["status_ispol"] : ""; ?>';
            var showIspolOnly =
                '<?php echo isset($_QRY_ISPOL["showispolonly"]) ? $_QRY_ISPOL["showispolonly"] : ""; ?>';
        ...
        //
        var ispolStatus = '<?php echo isset($_QRY_ISPOL["status_ispol"]) ? $_QRY_ISPOL["status_ispol"] : ""; ?>';
        if (ispolStatus === "1") {
