...
<div class="mt-3">
    ...
    <ul class="list-group list-group-horizontal-lg table-legend">
        <li class="list-group-item border-light flex-fill text-justify w-50">
            ...
            <div class="ml-3">
                <span><i class="fa-solid fa-user text-dark pr-2"></i>По документу есть <u>один</u> ответственный. Клик
            ...
            <div class="text-left"><span class="text-info pr-2"><b>Получатель</b></span>Руководитель или сотрудник, на
                имя которого был получен официальный документ.</div>
            <div class="ml-3">
                <span><i class="fa-solid fa-share fa-2xs fa-beat-fade text-primary pr-2"></i>Если рядом с именем
                    получателя Вы видите этот символ, то это значит, что по истечении срока исполнения по документу на
                    email руководителей компании (Бернер, Рощин) придет уведомление, если на этот момент документ был
                    <u>не исполнен</u> ответственным при <u>активном</u> режиме контроля исполнения.</span>
            </div>
        </li>
        <li class="list-group-item border-light flex-fill text-justify w-50">
    ...
    <ul class="list-group list-group-horizontal-lg table-legend">
        <li class="list-group-item border-light flex-fill text-center col">
            <div class="text-left d-flex flex-column justify-content-start text-center">
                <div style="width:100%" class="mb-1">
                    <div style="background-color:rgb(201, 226, 201)" class="text-small text-nowrap p-1">Документ типа
                        "Запрос ответа"</div>
                </div>
                <div class="text-dark text-left px-3">
                    <p><i class="fa-solid fa-check mr-2"></i>На документ был дан ответ в виде ответного исходящего
                        документа
                        и он был отмечен как выполненный.</p>
                </div>
            </div>
        </li>
        <li class="list-group-item border-light flex-fill text-center col">
            <div class="text-left d-flex flex-column justify-content-start text-center">
                <div style="width:100%" class="mb-1">
                    <div style="background-color:rgb(247, 215, 178)" class="text-small text-nowrap p-1">Документ типа
                        "Запрос ответа"</div>
                </div>
                <div class="text-dark text-left px-3">
                    <p><i class="fa-solid fa-check mr-2"></i>На документ был дан ответ любым иным способом без
                        исходящего
                        письма и данный документ был отмечен как выполненный.</p>
                    <p><i class="fa-solid fa-check mr-2"></i>Ответ на данный документ существует, но отметка о
                        выполнении до сих пор не выставлена.</p>
                </div>
        </li>
        <li class="list-group-item border-light flex-fill text-center col">
            <div class="text-left d-flex flex-column justify-content-start text-center">
                <div style="width:100%" class="mb-1">
                    <div style="background-color:rgb(226, 201, 201)" class="text-small text-nowrap p-1">Документ типа
                        "Запрос ответа"</div>
                </div>
                <div class="text-dark text-left px-3">
                    <p><i class="fa-solid fa-check mr-2"></i>На документ не был дан ответ и он не был отмечен как
                        выполненный.</p>
                </div>
            </div>
        </li>
        ...
        <li class="list-group-item border-light flex-fill text-justify">
            <span><i class="fa-solid fa-ellipsis-vertical pr-2"></i></span><span class="">Кликом мышки открыть или
               ...
               class="fa-regular fa-comments pr-2" style="color:#E0E0E0"></i><span class="">По клику во всплывающем окне
                ...
                комментариев нет)</span><span class="text-danger px-1">&bull;</span><i
               class="fa-solid fa-star-of-life fa-xs"></i><i class="fa-solid fa-star-of-life fa-xs"></i><span
                  class="">По клику во всплывающем окне
                посмотреть все дополнительные исходящие связи с другими документами входящей и исходящей почты, а также
                договоров</span>
        </li>
    </ul>
