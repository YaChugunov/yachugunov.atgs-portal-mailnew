...
?>
<link rel="stylesheet"
      href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-incoming-filters.css">
...
<p class="mail-incoming-filters-button">
    ...
    <button class="btn btn-sm btn-outline-secondary" type="button" data-toggle="collapse"
            data-target="#mail-incoming-filters-block" aria-expanded="false"
            aria-controls="mail-incoming-filters-block">
        ...
        <div class="card card-body bg-light border-0 w-100">
            ...
            <div class="block d-flex flex-row">
                ...
                <div class="form-group w-25 mb-3 mx-1">
                    ...
                    <input type="text" class="form-control" id="filterNumber" name="filterNumber"
                           aria-describedby="filterNumberHelp" placeholder="Номер или часть номера документа">
                ...
                <div class="form-group w-25 mb-3 mx-1">
                    ...
                    <input type="text" class="form-control" id="filterKOD" name="filterKOD"
                           aria-describedby="filterKODHelp" placeholder="Целиком или часть ID документа">
                </div>
                <!-- Блок -->
                <div class="form-group w-25 mb-3 mx-1">
                    ...
                    <input type="text" class="form-control" id="filterSourceID" name="filterSourceID"
                           aria-describedby="filterSourceIDHelp" placeholder="Часть исходящего номера контрагента">
                </div>
            </div>
            <div class="block d-flex flex-row">
                <!-- 
            ...
            <div class="block d-flex flex-row">
                ...
                <div class="form-group flex-fill mb-3 mx-1">
                    ...
                    <input type="text" class="form-control" id="filterAbout" name="filterAbout"
                           placeholder="Что-нибудь из темы документа">
                </div>
                <!-- Блок -->
                <div class="form-group flex-fill mb-3 mx-1">
                    <label for="filterSender">Организация-отправитель</label>
                    <input type="text" class="form-control" id="filterSender" name="filterSender"
            ...
            <div class="block d-flex flex-row justify-content-end">
                <div class="form-group">
                    ...
                    <button id="columnSearch_btnClear" type="button"
                            class="btn btn-sm btn-outline-secondary">Очистить</button>
                </div>
            </div>
