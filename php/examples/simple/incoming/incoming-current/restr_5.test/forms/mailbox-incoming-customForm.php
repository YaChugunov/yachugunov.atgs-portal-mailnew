...
// :::
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-incoming-customForm.css">
<style>
                ...
                <div class="section d-flex flex-column">
                    ...
                    <div class="block d-flex flex-row">
                        <div class="block d-flex flex-column w-50">
                            ...
                            <fieldset class="field">
                                <editor-field name="inbox_controlIspolActive_preOpen">
                                </editor-field>
                            </fieldset>
                            <fieldset class="field checkbox-inline">
                ...
                <div class="section d-flex flex-column">
                    ...
                    <div class="block d-flex flex-column">
                        <div class="d-flex flex-row">
                            ...
                            <fieldset class="field w-75 docSender">
                    ...
                    <div class="block d-flex flex-column">
                        <div class="block d-flex flex-column">
                            <fieldset class="field docSender section-block sender-searchinspmanual">
                                <editor-field name="<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docSender_kodzakazm">
                                </editor-field>
                            </fieldset>
                        </div>
                        <div class="block d-flex flex-column">
                            <!-- <h4 class="section-title">Если не нашли в ранее введенных вручную, вводим сейчас</h4> -->
                            <div id="sender-manualinput-alert" class="small mx-3 mb-0 sender-manualinput-alert block d-flex flex-column" style="display:none">
                                <div class="d-flex flex-column w-100">
                                    <div class="alert alert-warning alert-fadein fade show sender-manualinput-alert" style="display:none">
                                        <p class="mb-1 text-justify pr-4">Если вы видите это сообщение, то видимо вы
                                            не
                                            смогли найти нужного
                                            контрагента в Справочнике, поэтому вам предлагается ввести требуемую
                                            организацию
                                            вручную. Но и тут не все так просто...</p>
                                        <p class="mb-1 text-justify pr-4">При вводе сервис все равно будет проверять
                                            вводимое вами название на совпадение с организациями как в Справочнике,
                                            так
                                            и в
                                            списке ранее уже введенных вручную контрагентов. Если обнаружите нужную
                                            вам
                                            - не
                                            поленитесь и выберите из предложенных.</p>
                                    </div>
                                    <div class="d-flex flex-column">
                                        <div class="d-flex flex-row">
                                            <fieldset class="field checkbox-inline section-block sender-manualinput-chk enblSenderManual" style="margin-top:1.5rem">
                                                <editor-field name="enblSenderManual"></editor-field>
                                            </fieldset>
                                            <fieldset class="field docSenderOrg section-block sender-manualinput-text w-50">
                                                <editor-field name="<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docSender">
                                                </editor-field>
                                            </fieldset>
                                        </div>
                                        <div id="manualInput-searchResults" class="mb-3 " style="display:none">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="doc-editor-tab-5" class="tab-pane fade">
                <div class="section d-flex flex-column">
                    ...
                    <div class="block">
                        ...
                        <fieldset class="field">
                            <editor-field name="<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_tmp5"></editor-field>
                        </fieldset>
                    </div>
                </div>
            </div>
