...
<script type="text/javascript" language="javascript" class="">
    ...
    if (isMobile) {
        console.log('Mobile deivice');
        // similar behavior as an HTTP redirect
        window.location.replace(
            "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_WORKPATH; ?>/mailbox-profile-nomobile.php"
        );
        // similar behavior as clicking on a link
        // window.location.href = "http://yandex.ru";
    } else {
        console.log('Tablet or Desctop deivice');
    }
    ...
    function ajaxRequest_profileFilesList(koddocmail, responseHandler) {
        request_profileFileList = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/process/ajaxrequests/ajaxReq-profilingDoc-docMain-files.php',
            cache: false,
            data: {
    ...
    function ajaxRequest_profileContragentInfo(koddocmail, responseHandler) {
        request_profileContragentInfo = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/process/ajaxrequests/ajaxReq-profilingDoc-Zak-info.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_contragentLastInc(kodcontragent, responseHandler) {
        request_contragentLastInc = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/process/ajaxrequests/ajaxReq-profilingDoc-byZak-lastInc.php',
            cache: false,
            data: {
    ...
    function ajaxRequest_contragentLastOut(kodcontragent, responseHandler) {
        request_contragentLastOut = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/process/ajaxrequests/ajaxReq-profilingDoc-byZak-lastOut.php',
            cache: false,
            data: {
                kodcontragent: kodcontragent
            },
    ...
    function ajaxRequest_contragentDogs(kodcontragent, responseHandler) {
        request_contragentDogs = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/process/ajaxrequests/ajaxReq-profilingDoc-byZak-dogs.php',
            cache: false,
            data: {
                kodcontragent: kodcontragent
            },
    ...
    function ajaxRequest_contragentChfzadol(kodcontragent, responseHandler) {
        request_contragentChfzadol = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/process/ajaxrequests/ajaxReq-profilingDoc-byZak-zadolChf.php',
            cache: false,
            data: {
                kodcontragent: kodcontragent
            },
    ...
    function ajaxRequest_contragentUnoplav(kodcontragent, responseHandler) {
        request_contragentUnoplav = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/process/ajaxrequests/ajaxReq-profilingDoc-byZak-unOplav.php',
            cache: false,
            data: {
                kodcontragent: kodcontragent
            },
    ...
    function ajaxRequest_profileDocInfo(koddocmail, responseHandler) {
        request_profileDocInfo = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/process/ajaxrequests/ajaxReq-profilingDoc-docMain-info.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_docLinkedInc(koddocmail, responseHandler) {
        request_docLinkedInc = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/process/ajaxrequests/ajaxReq-profilingDoc-byDocMain-linkedInc.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_docLinkedOut(koddocmail, responseHandler) {
        request_docLinkedOut = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/process/ajaxrequests/ajaxReq-profilingDoc-byDocMain-linkedOut.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_docLinkedDog(koddocmail, responseHandler) {
        request_docLinkedDog = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/process/ajaxrequests/ajaxReq-profilingDoc-byDocMain-linkedDog.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_docLinkedContr(koddocmail, responseHandler) {
        request_docLinkedContr = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/process/ajaxrequests/ajaxReq-profilingDoc-byDocMain-linkedContr.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_byLinkedDoc2Inc(str, koddoc, byWhat, responseHandler) {
        request_byLinkedDoc2Inc = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/process/ajaxrequests/ajaxReq-profilingDoc-byLinkedDog-linkedInc.php',
            cache: false,
            data: {
                str: str,
                koddoc: koddoc
    ...
    function ajaxRequest_byLinkedDoc2Out(str, koddoc, byWhat, responseHandler) {
        request_byLinkedDoc2Out = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/process/ajaxrequests/ajaxReq-profilingDoc-byLinkedDog-linkedOut.php',
            cache: false,
            data: {
                str: str,
                koddoc: koddoc
    ...
    function ajaxRequest_byLinkedDocFiles(str, byWhat, responseHandler) {
        request_byLinkedDocFiles = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/process/ajaxrequests/ajaxReq-profilingDoc-byLinkedDog-files.php',
            cache: false,
            data: {
                str: str
            },
    ...
    function ajaxRequest_byLinkedDocSums(koddoc, byWhat, responseHandler) {
        request_byLinkedDocSums = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/process/ajaxrequests/ajaxReq-profilingDoc-byLinkedDog-sums.php',
            cache: false,
            data: {
                koddoc: koddoc
            },
...
if ($noerrors) {
?>
    <link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_PROFILE_WORKPATH . __MAIL_RESTR; ?>/css/mailbox-incoming-profile.css">
...
<div class="container mt-5">
    <div class="col-sm-12">
        <div class="text-center profiling-link"><a href="index.php?type=in&mode=archive&rel=<?php echo $_reqDB_docmail['koddocmail']; ?>">Вернуться к
                документу во входящих</a></div>
    </div>
</div>
