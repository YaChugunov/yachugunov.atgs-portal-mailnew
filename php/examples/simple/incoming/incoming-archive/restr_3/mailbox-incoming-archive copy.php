...
$ispolStatus_msg_1 = '<span class="errtext">В текущей конфигурации сервиса управлять напоминаниями и уведомлениями исполнителю(ям) могут только сами исполнители. Кроме того, также должен быть активен режим КИ (контроль исполнения) и установлен дедлайн.</span>';
...
<script type="text/javascript" language="javascript" class="init">
    ...
    function ajaxRequest_saveToDB_showIspolOnly(responseHandler) {
        ...
        request_showIspolOnly = $.ajax({
            url: "../mail/_assets/php/mail-reqAjax-saveToDB-showispolonly.php",
            type: "post",
            cache: false,
            data: {
                userID: _userid,
    ...
    function ajaxRequest_loadFromDB_showIspolOnly(responseHandler) {
        ...
        // Fire off the request_addItem to /form.php
        request_showIspolOnly = $.ajax({
            url: "../mail/_assets/php/mail-reqAjax-loadFromDB-showispolonly.php",
            type: "post",
            cache: false,
            data: {
                userID: _userid
    ...
    function ajaxRequest_uploadAttachedFiles(formData, responseHandler) {
        ...
        request_uploadAttachedFiles = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-uploadAttachedFiles.php',
            cache: false,
            contentType: false,
            processData: false,
            data: formData,
    ...
    function ajaxRequest_listAttachedFiles(koddocmail, responseHandler) {
        ...
        request_listAttachedFiles = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-listAttachedFiles.php',
            cache: false,
            data: {
    ...
    function ajaxRequest_deleteAttachedFile(rowid, responseHandler) {
        ...
        request_deleteAttachedFile = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-deleteAttachedFile.php',
            cache: false,
            data: {
                rowID: rowid
            },
    ...
    function ajaxRequest_getLastDeadlineMail(koddocmail, userid, responseHandler) {
        ...
        request_getLastDeadlineMail = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-getLastDeadlineMail.php',
            cache: false,
            data: {
                koddocmail: koddocmail,
                userid: userid
    ...
    function ajaxRequest_getLastNotify(action, koddocmail, parameter, responseHandler) {
        ...
        request_getLastNotify = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-getLastNotify.php',
            cache: false,
            data: {
                koddocmail: koddocmail,
                parameter: parameter,
    ...
    function ajaxRequest_getLastAction(koddocmail, parameter, responseHandler) {
        ...
        request_getLastAction = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-getLastAction.php',
            cache: false,
            data: {
                koddocmail: koddocmail,
                parameter: parameter
    ...
    function ajaxRequest_getLinkedRelFiles(koddocmail, responseHandler) {
        ...
        request_getLinkedRelFiles = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-getLinkedRelFiles.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_countDocComments(koddocmail, responseHandler) {
        ...
        request_countDocComments = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-countDocComments.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_getUserCheckout(koddocmail, userid, responseHandler) {
        ...
        request_getUserCheckout = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-getUserCheckout.php',
            cache: false,
            data: {
                userid: userid,
                koddocmail: koddocmail
    ...
    function ajaxRequest_getDocTypeLock(koddocmail, responseHandler) {
        ...
        request_getDocTypeLock = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-getDocTypeLock.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    $(document).ready(function() {
        ...
        editor_incoming = new $.fn.dataTable.Editor({
            display: "bootstrap",
            ajax: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-incoming-process.php",
            table: "#inbox",
            i18n: {
                create: {
            ...
            fields: [{
                    ...
                    label: "Основное исходящее письмо, для которого редактируемое будет ответным ( Дата / Номер / Контрагент / Тема )",
                    ...
                    label: "Организация / Подписант (Справочник)",
        ...
        editor_incoming.on('initEdit', function(e, node, data, items, type) {
            console.log('inbox_docFileID', data.<?php echo __MAIL_INCOMING_TABLENAME; ?>
                .inbox_docFileID);
            editor_incoming.field('<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docFileIDtmp').val(
                data
        ...
        editor_incoming.on('preOpen', function(e, mode, action) {
            $.getJSON(
                    "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/fields-help-data.json"
                )
                .done(function(json) {
                    console.log("----- getJSON >>>>>");
        ...
        editor_incoming.on('open', function(e, mode, action) {
            ...
            $('#DTE_Field_mailbox_incoming-inbox_docContractor_kodzayvispol option:first').prop(
                'disabled',
                true);
            // if (editor_incoming.field(
            //         '<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_controlIspolUseDeadline').val() ==
            //     '0') {
            //     editor_incoming.field('<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docDateDeadline').val(
            //         '');
            // }
            ...
            editor_incoming.on('preClose', function(e) {
                ...
                if (openVals !== JSON.stringify(editor_incoming.get())) {
                    return confirm(
                        'Вы сделали изменения в записи, но не сохранили. Уверены, что хотите завершить редактирование?'
                    );
                }
            })
            ...
            $('#inbox-doc-links-btnAdd').click(function() {
                if ($(
                    ...
                    editor_incoming.field(
                        ...
                        selMultiStr);
                    console.log('field inbox_rowIDs_links:', editor_incoming.field(
                            '<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_rowIDs_links')
                        .val());
            ...
            $('#outbox-doc-links-btnAdd').click(function() {
                if ($(
                    ...
                    editor_incoming.field(
                        ...
                        selMultiStr);
                    console.log('field outbox_rowIDs_links:', editor_incoming.field(
                            '<?php echo __MAIL_INCOMING_TABLENAME; ?>.outbox_rowIDs_links')
                        .val());
                    ...
                    $.getJSON(
                        ...
                        .done(function(json) {
                            ...
                            for (var key1 in json.data) {
                                ...
                                var $content = json.data[key1]['popoverContent'].length > 450 ?
                                    json.data[key1][
                                        'popoverContent'
                                    ].substring(0,
                                        450) +
                                ...
                                $('label[for="' + json.data[key1]['id'] +
                                        '"] > a[fieldName="popoverContent-' + key1 + '"]')
                                    .popover({
                                        html: true,
                                        trigger: 'click hover',
                                        placement: 'right',
            ...
            if (editor_incoming.field(
                ...
                editor_incoming.field('ispolStatus').disable();
                editor_incoming.field(
                    '<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_controlIspolUseDeadline').disable();
            }
        ...
        editor_incoming.on('preSubmit', function(e, data, action) {
            ...
            if (action !== "remove") {
                ...
                if (editor_incoming.field(
                    ...
                    $("#doc-editor-menu-tab-1-errmsg").addClass("text-danger errmsg");
                    editor_incoming.field(
                            '<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docRecipient_kodzayvtel'
                        )
                ...
                if (editor_incoming.field(
                    ...
                    $("#doc-editor-menu-tab-3-errmsg").html(
                        '<i class="fa-solid fa-circle-exclamation"></i>');
                    $("#doc-editor-menu-tab-3-errmsg").addClass("text-danger errmsg");
                    $('#ispol-selected-str').html('<?php echo $tab3_ispolList_msg_0; ?>');
                    // editor_incoming.field(
                    //     '<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docContractor_kodzayvispol'
                    // ).set("000000000000000");
                    // $('#DTE_Field_ispolSelectedClear_0').prop("checked", true);
                    // $('#DTE_Field_<?php echo __MAIL_INCOMING_TABLENAME; ?>-inbox_docContractor_kodzayvispol')
                    //     .prop('disabled', true);
                    errmsg_3 = true;
                } else {
                ...
                if (editor_incoming.field(
                    ...
                    $("#doc-editor-menu-tab-4-errmsg").html(
                        '<i class="fa-solid fa-circle-exclamation"></i>');
                    $("#doc-editor-menu-tab-4-errmsg").addClass("text-danger errmsg");
                    editor_incoming.field(
                        '<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docSourceID').error(
                        'Введите исходящий номер');
                    // e.preventDefault;
                    errmsg_4 = true;
                    console.log('#doc-editor-tab-4 span.select2-selection__rendered', $(
                        '#doc-editor-tab-4 span.select2-selection__rendered').text());
                } else if ($('#doc-editor-tab-4 span.select2-selection__rendered').text() ===
                    '') {
                    $("#doc-editor-menu-tab-4-errmsg").html(
                        '<i class="fa-solid fa-circle-exclamation"></i>');
                    $("#doc-editor-menu-tab-4-errmsg").addClass("text-danger errmsg");
            ...
            $('#DTE_Field_<?php echo __MAIL_INCOMING_TABLENAME; ?>-outbox_docIDs_links').val(null)
                .trigger(
                    "change");
            $('#DTE_Field_<?php echo __MAIL_INCOMING_TABLENAME; ?>-dognet_docIDs_links').val(null)
                .trigger(
                    "change");
        })
        // БЛОК ОБРАБОТКИ ОШИБОК ЗАПОЛНЕНИЯ ФОРМЫ
        ...
        //
        //
        editor_incoming.dependent('<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_controlIspolUseDeadline',
            function(val, data, callback, e) {
                console.log("editor_incoming.dependent('inbox_controlIspolUseDeadline')", val);
                if (val == "1") {
                    editor_incoming.field('<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docDateDeadline')
                        .enable();
        ...
        //
        //
        editor_incoming.dependent('ispolStatus',
            function(val, data, callback, e) {
        ...
        editor_incoming.dependent('enblSenderManual', function(val, data, callback, e) {
            ...
            if (val == "1") {
                editor_incoming.field('<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docSender')
                    .enable();
                editor_incoming.field('<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docSenderName')
                    .enable();
                editor_incoming.field('<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_tmp1').set(
                    editor_incoming.field(
                        '<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docSender_kodzakaz').get());
                ...
                if ((editor_incoming.field('<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_tmp1')
                    ...
                    '') {
                    editor_incoming.field(
                        '<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docSender_kodzakaz').set(
                        editor_incoming
        ...
        //
        //
        editor_incoming.dependent('<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docType',
            function(val, data, callback, e) {
                if (val === '2') {
                    editor_incoming.field('<?php echo __MAIL_INCOMING_TABLENAME; ?>.outbox_rowID_rel')
                        .enable();
                    ...
                    editor_incoming.field('<?php echo __MAIL_INCOMING_TABLENAME; ?>.outbox_rowID_rel')
                        .disable();
                    editor_incoming.val('<?php echo __MAIL_INCOMING_TABLENAME; ?>.outbox_rowID_rel', null);
                    editor_incoming.field('<?php echo __MAIL_INCOMING_TABLENAME; ?>.outbox_rowIDadd_rel')
                        .disable();
                    editor_incoming.val('<?php echo __MAIL_INCOMING_TABLENAME; ?>.outbox_rowIDadd_rel',
                        null);
                    editor_incoming.field('<?php echo __MAIL_INCOMING_TABLENAME; ?>.outbox_rowIDList_rel')
                        .disable();
                    editor_incoming.val('<?php echo __MAIL_INCOMING_TABLENAME; ?>.outbox_rowIDList_rel',
                        null);
            ...
            function(val, data, callback, e) {
                ...
                if (val == "1") {
                    ...
                    editor_incoming.field(
                        ...
                        .disable();
                    editor_incoming.field(
                        '<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_controlIspolUseDeadline').val(0);
                }
                callback(true);
            }
        );
        ...
        table_incoming = $('#inbox').DataTable({
            ...
            language: {
                url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/dt_russian-mail.json"
            },
            ajax: {
                url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-incoming-process.php",
                type: "POST"
            },
            serverSide: true,
            createdRow: function(row, data, index) {
                if (data.<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docType == 3) {
                    if (data.<?php echo __MAIL_INCOMING_TABLENAME; ?>.outbox_docID_rel == '' || data
                        .<?php echo __MAIL_INCOMING_TABLENAME; ?>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(id) {
                        ...
                        return id ?
                            '<a class="" target="_blank" href="' + table_incoming.file(
                                '<?php echo __MAIL_INCOMING_FILES_TABLENAME; ?>', id)
                            .file_webpath +
                            '">' + ext_ico + '</a>' :
                            '-';
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        let sourceID = row.<?php echo __MAIL_INCOMING_TABLENAME; ?>
                            ...
                            .<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docSourceID : "no ID";
                        let sourceDate = row.<?php echo __MAIL_INCOMING_TABLENAME; ?>
                            .inbox_docSourceDate !== "" &&
                            row.<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docSourceDate !==
                            null && typeof row
                            .<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_docSourceDate !==
                        ...
                        let tags =
                            '<span style="padding-left:5px; padding-right:5px" data-toggle="tooltip" data-placement="top" title="Теги по документу"><i style="color:#E0E0E0" class="fa-solid fa-tags fa-lg" aria-hidden="true"></i></span>';
                        if (fullStr.length > 30) {
                            ...
                            return '<span style="float:left">' + fullStr +
                                '</span><span style="float:right">' + tags + sourceInfo + '</span>';
                        }
                    }
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        if (fullStr.length > 26) {
                            return '<span class="about" data-toggle="tooltip" title="' + fullStr +
                                '">' + shortStr + '</span>';
                        } else {
                            return fullStr;
                        }
                ...
                },
                {
                    ...
                    targets: 7,
                    render: function(data, type, row, meta) {
                        koddocmail = row.<?php echo __MAIL_INCOMING_TABLENAME; ?>.koddocmail;
                        ...
                        if (multi == "1") {
                            ...
                            contractor_1 = x[0];
                            if (ispolactive == "1") {
                                return '<span style="float:left">' + contractor_1 +
                                    '</span><span style="float:right"><span data-toggle="tooltip" title="Ответственные - ' +
                                    data +
                                    '"><span id="link-logCheckouts" data-toggle="modal" data-type="logCheckouts" data-id="' +
                                    koddocmail +
                                    '" data-target="#modal-logCheckouts"><i class="fa fa-users" aria-hidden="true"></i></span></span></span>';
                            } else {
                                return '<span style="float:left">' + contractor_1 +
                                    '</span><span style="float:right"><span data-toggle="tooltip" title="Ответственные - ' +
                                    data +
                                    ...
                                    koddocmail +
                                    '" data-target="#modal-noControlIspolActive"><i class="fa fa-users" aria-hidden="true"></i></span></span></span>';
                            }
                        } else {
                            res = data.replace(new RegExp("\\r?\\n", "g"), "");
                            x = res.split(',');
                            ...
                            if (data !== "---") {
                                if (ispolactive == "1") {
                                    return '<span style="float:left">' + contractor_2 +
                                        '</span><span style="float:right"><span data-toggle="tooltip" title="Ответственный - ' +
                                        data +
                                        '"><span id="link-logCheckouts" data-toggle="modal" data-type="logCheckouts" data-id="' +
                                        koddocmail +
                                        '" data-target="#modal-logCheckouts"><i class="fa-regular fa-user" aria-hidden="true"></i></span></span></span>';
                                } else {
                                    return '<span style="float:left">' + contractor_2 +
                                        '</span><span style="float:right"><span data-toggle="tooltip" title="Ответственный - ' +
                                        data +
                                        '"><span id="link-noControlIspolActive" data-toggle="modal" data-type="noControlIspolActive" data-id="' +
                                        koddocmail +
                                        '" data-target="#modal-noControlIspolActive"><i class="fa-regular fa-user" aria-hidden="true"></i></span></span></span>';
                                }
                            } else {
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        moment.locale('en');
                        var controlDiff1 = 86400 * 1;
                        var controlDiff3 = 86400 * row.<?php echo __MAIL_INCOMING_TABLENAME; ?>
                            .inbox_controlIspolDays;
                        ...
                        if (row.<?php echo __MAIL_INCOMING_TABLENAME; ?>
                            ...
                            if (row.<?php echo __MAIL_INCOMING_TABLENAME; ?>
                                ...
                                if (row.<?php echo __MAIL_INCOMING_TABLENAME; ?>
                                    ...
                                    if (diffSecs > controlDiff1 && diffSecs <= controlDiff3) {
                                        return '<div class="control"><div class="spanWarning"><div class="spanText"><span class="" data-toggle="tooltip" data-html="true" data-placement="auto" title="Контроль исполнения активен.<br>Дедлайн - ' +
                                            ...
                                            diffDays +
                                            '</span></div></div></div>';
                                    } else if (diffSecs > 0 && diffSecs <= controlDiff1) {
                    ...
                    render: function(data, type, row, meta) {
                        if (data !== null && typeof data !== 'undefined' && data !==
                            ...
                            return '<div id="link-listAddFiles" data-toggle="modal" data-type="listAddFiles" data-id="' +
                                ...
                                .koddocmail +
                                '" data-target="#modal-listAddFiles"><span class=""><i class="fa-regular fa-file-lines fa-lg"></i></span></div>';
                        } else {
                            return "-";
                        }
                    },
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        if (data != null && row.<?php echo __MAIL_INCOMING_TABLENAME; ?>
                            ...
                            .<?php echo __MAIL_INCOMING_TABLENAME; ?>
                            .outbox_rowID_rel != 0) {
                            return '<div class=""><a class="text-dark" href="<?php echo __ROOT . __SERVICENAME_MAILNEW; ?>/index.php?type=out&mode=archive&rel=' +
                                row.<?php echo __MAIL_INCOMING_TABLENAME; ?>
                                .outbox_koddocmail_rel +
                                '"><div class="docnum">' + row
                                .<?php echo __MAIL_INCOMING_TABLENAME; ?>
                                .outbox_docID_rel + '</div></a></div>';
                    ...
                    render: function(data, type, row, meta) {
                        if (data !== null && typeof data !== 'undefined' && data !== "") {
                            return '<div id="link-listLinkDocs" data-toggle="modal" data-type="listLinkDocs" data-id="' +
                                row.<?php echo __MAIL_INCOMING_TABLENAME; ?>
                                .koddocmail +
                                '" data-target="#modal-listLinkDocs"><i class="fa-regular fa-file-lines fa-lg"></i></div>';
                        } else {
                            return "-";
                        }
                    },
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        if ((inboxLinks !== null && typeof inboxLinks !== 'undefined' &&
                            ...
                            return '<div id="link-listAdditionalLinkDocs" data-toggle="modal" data-type="listAdditionalLinkDocs" data-id="' +
                                row.<?php echo __MAIL_INCOMING_TABLENAME; ?>
                                .koddocmail +
                                '" data-target="#modal-listAdditionalLinkDocs"><i class="fa fa-chain fa-lg" aria-hidden="true"></i></div>';
                        } else {
                            return "-";
                        }
                    },
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        return '<div id="link-logChanges" data-toggle="modal" data-type="logChanges" data-id="' +
                            ...
                            '" data-target="#modal-logChanges"><span class=""><i class="fa-regular fa-rectangle-list fa-lg"></i></span></div>';
                    }
                },
                {
                    orderable: false,
                    ...
                    render: function(data, type, row, meta) {
                        if (data) {
                            return '<div id="link-logComments" data-toggle="modal" data-type="logComments" data-id="' +
                                row.<?php echo __MAIL_INCOMING_TABLENAME; ?>
                                .koddocmail +
                                '" data-target="#modal-logComments"><span class=""><i class="fa-solid fa-comments fa-lg"></i></span></div>';
                        } else {
                            return '<div id="link-logComments" data-toggle="modal" data-type="logComments" data-id="' +
                                row.<?php echo __MAIL_INCOMING_TABLENAME; ?>
                                .koddocmail +
                                '" data-target="#modal-logComments"><span class="" style="color:#E0E0E0"><i class="fa-regular fa-comments fa-lg"></i></span></div>';
                        }
                    }
                }
            ],
        ...
        $('#inbox tbody').on('click', 'td.details-control', function() {
            ...
            if (row.child.isShown()) {
                ...
                d.ispolCheckoutWhen = d.<?php echo __MAIL_INCOMING_TABLENAME; ?>
                    ...
                    .inbox_controlIspolCheckoutWhen;
                d.ispolStatus = d.<?php echo __MAIL_INCOMING_TABLENAME; ?>.inbox_controlIspolStatus;
                //
        ...
        $(document).on("click", "span#link-logCheckouts", function() {
            ...
            $('#table-logCheckouts').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-incoming-process-showLogCheckouts.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            if (data == "1") {
                                return '<span class=""><i class="fa-regular fa-square-check"></i></span>';
                            } else {
                                return '<span class=""><i class="fa-regular fa-square"></i></span>';
                            }
                        }
                    }
                ],
        ...
        $(document).on("click", "div#link-logChanges", function() {
            ...
            $('#table-logChanges').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-incoming-process-showLogChanges.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-logComments", function() {
            ...
            editor_logComments = new $.fn.dataTable.Editor({
                display: "bootstrap",
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-incoming-process-showLogComments.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-listAddFiles", function() {
            ...
            editor_listAddFiles = new $.fn.dataTable.Editor({
                display: "bootstrap",
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-incoming-process-showLogAddFiles.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-listLinkDocs", function() {
            ...
            table_listLinkDocs = $('#table-listLinkDocs').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-incoming-process-showLogLinkDocs.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-listAdditionalLinkDocs", function() {
            ...
            var table_listAdditionalLinkDocsDog = $('#table-listAdditionalLinkDocsDog').dataTable({
                dom: "<'row'<'col-sm-5'><'col-sm-4'><'col-sm-3'>>" +
                    "<'row'<'col-sm-12't>>" + "<'row'<'col-sm-8'><'col-sm-4'>>",
                language: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/dt_russian-docDogLinks.json"
                },
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-incoming-process-showLogAdditionalLinkDocsDog.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
            ...
            var table_listAdditionalLinkDocsMOut = $('#table-listAdditionalLinkDocsMOut')
                .dataTable({
                    dom: "<'row'<'col-sm-5'><'col-sm-4'><'col-sm-3'>>" +
                        "<'row'<'col-sm-12't>>" + "<'row'<'col-sm-8'><'col-sm-4'>>",
                    language: {
                        url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/dt_russian-docMailLinks.json"
                    },
                    ajax: {
                        url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-incoming-process-showLogAdditionalLinkDocsMOut.php",
                        type: "POST",
                        data: {
                            koddocmail: koddocmail
                        }
            ...
            var table_listAdditionalLinkDocsMInc = $('#table-listAdditionalLinkDocsMInc')
                .dataTable({
                    ...
                    ajax: {
                        url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/process/mailbox-incoming-process-showLogAdditionalLinkDocsMInc.php",
                        type: "POST",
                        data: {
                            koddocmail: koddocmail
                        }
...
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/css/common-modals.css">
...
// :::
include __DIR_ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3 . "/forms/mailbox-incoming-customForm.php";
include __DIR_ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3 . "/forms/mailbox-incoming-filters.php";
// ----- ----- ----- ----- -----
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-incoming.css">
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-incoming-details.css">

<section>
    <div id="divOnlyIspolMe" class="form-check checkbox mb-3">
        <input class="form-check-input" type="checkbox" value="" id="chkOnlyIspolMe">
        <label class="form-check-label ml-2" for="chkOnlyIspolMe">
            <b>Показывать только письма, где я ответственный. Ваш выбор сохранится.</b>
        </label>
    </div>
        ...
        <table id="inbox" class="table display compact" cellspacing="1" width="100%">
            <thead>
                <tr>
                    ...
                    <th>Д</th>
                    <th>КИ</th>
                    <th><span class="">Ф</span><span class=" small" style="font-size:65%">o</span></th>
                    <th><span class="">Ф</span><span class="small" style="font-size:65%">д</span></th>
                    <th><span class="">ЗО</span><span class="small" style="font-size:65%">o</span></th>
                    <th><span class="">ЗО</span><span class="small" style="font-size:65%">д</span></th>
                    <th>СВ</th>
                    <th>Ж</th>
                    <th>К</th>
                </tr>
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-incoming-modal-logCheckouts.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-incoming-modal-logChanges.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-incoming-modal-logComments.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-incoming-modal-listAddFiles.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-incoming-modal-listLinkDocs.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_CURRENT_WORKPATH . __MAIL_RESTR3; ?>/css/mailbox-incoming-modal-listAdditionalLinkDocs.css">
<div class="modal fade" data-backdrop="true" id="modal-listAdditionalLinkDocs" tabindex="-1" role="dialog" aria-labelledby="modal-listAdditionalLinkDocs-label" aria-hidden="true">
    <div class="modal-dialog modal-lg custom-modal mail-features" role="document">
        <div class="modal-content shadow">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-listAdditionalLinkDocs-label">Связанные договорыСвязанные Входящие / Исходящие /
