...
<script type="text/javascript" language="javascript" class="init">
    ...
    function ajaxRequest_uploadAttachedFiles(formData, responseHandler) {
        ...
        request_uploadAttachedFiles = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-uploadAttachedFiles.php',
            cache: false,
            contentType: false,
            processData: false,
            data: formData,
    ...
    function ajaxRequest_listAttachedFiles(koddocmail, responseHandler) {
        ...
        request_listAttachedFiles = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-listAttachedFiles.php',
            cache: false,
            data: {
    ...
    function ajaxRequest_deleteAttachedFile(rowid, responseHandler) {
        ...
        request_deleteAttachedFile = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-deleteAttachedFile.php',
            cache: false,
            data: {
                rowID: rowid
            },
    ...
    function ajaxRequest_getLastDeadlineMail(koddocmail, userid, responseHandler) {
        ...
        request_getLastDeadlineMail = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-getLastDeadlineMail.php',
            cache: false,
            data: {
                koddocmail: koddocmail,
                userid: userid
    ...
    function ajaxRequest_getLastNotify(action, koddocmail, parameter, responseHandler) {
        ...
        request_getLastNotify = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-getLastNotify.php',
            cache: false,
            data: {
                koddocmail: koddocmail,
                parameter: parameter,
    ...
    function ajaxRequest_getLastAction(koddocmail, parameter, responseHandler) {
        ...
        request_getLastAction = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-getLastAction.php',
            cache: false,
            data: {
                koddocmail: koddocmail,
                parameter: parameter
    ...
    function ajaxRequest_getLinkedRelFiles(koddocmail, responseHandler) {
        ...
        request_getLinkedRelFiles = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-getLinkedRelFiles.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_countDocComments(koddocmail, responseHandler) {
        ...
        request_countDocComments = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-countDocComments.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_getDocTypeLock(koddocmail, responseHandler) {
        ...
        request_getDocTypeLock = $.ajax({
            type: "post",
            url: '<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-getDocTypeLock.php',
            cache: false,
            data: {
                koddocmail: koddocmail
            },
    ...
    function ajaxRequest_checkOnCurrYearAsync(koddocmail) {
        ...
        $.ajax({
            ...
            cache: false,
            type: "post",
            url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/ajaxrequests/ajaxReq-mailboxIncoming-checkRecordOnCurrentYear.php",
            data: {
                koddocmail: koddocmail
            },
    ...
    $(document).ready(function() {
        ...
        table_incoming = $('#inbox').DataTable({
            dom: "<'row '<'col-sm-6'B><'col-sm-6 d-inline-flex justify-content-end'l>>" +
                "<'row'<'col-sm-12'tr>>" +
                "<'row'<'col-sm-6'i><'col-sm-6'p>>",
            // dom: "<'row'<'col-sm-5'B><'col-sm-4'><'col-sm-3'l>>" +
            //   "<'row'<'col-sm-12'tr>>" + "<'row'<'col-sm-4'i><'col-sm-8'p>>",
            language: {
                url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/dt_russian-mail.json"
            },
            ajax: {
                url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-incoming-process.php",
                type: "POST"
            },
            ...
            stateSaveCallback: function(settings, data) {
                sessionStorage.setItem('DataTables_IncArch' + settings.sInstance, JSON.stringify(data))
            },
            stateLoadCallback: function(settings) {
                return JSON.parse(sessionStorage.getItem('DataTables_IncArch' + settings.sInstance))
            },
        ...
        $(document).on("click", "span#link-logCheckouts", function() {
            ...
            $('#table-logCheckouts').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-incoming-process-showLogCheckouts.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-logChanges", function() {
            ...
            $('#table-logChanges').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-incoming-process-showLogChanges.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-logComments", function() {
            ...
            editor_logComments = new $.fn.dataTable.Editor({
                display: "bootstrap",
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-incoming-process-showLogComments.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-listAddFiles", function() {
            ...
            editor_listAddFiles = new $.fn.dataTable.Editor({
                display: "bootstrap",
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-incoming-process-showLogAddFiles.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-listLinkDocs", function() {
            ...
            table_listLinkDocs = $('#table-listLinkDocs').dataTable({
                ...
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-incoming-process-showLogLinkDocs.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
        ...
        $(document).on("click", "div#link-listAdditionalLinkDocs", function() {
            ...
            var table_listAdditionalLinkDocsDog = $('#table-listAdditionalLinkDocsDog').dataTable({
                dom: "<'row'<'col-sm-5'><'col-sm-4'><'col-sm-3'>>" +
                    "<'row'<'col-sm-12't>>" + "<'row'<'col-sm-8'><'col-sm-4'>>",
                language: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/dt_russian-docDogLinks.json"
                },
                ajax: {
                    url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-incoming-process-showLogAdditionalLinkDocsDog.php",
                    type: "POST",
                    data: {
                        koddocmail: koddocmail
                    }
            ...
            var table_listAdditionalLinkDocsMOut = $('#table-listAdditionalLinkDocsMOut')
                .dataTable({
                    dom: "<'row'<'col-sm-5'><'col-sm-4'><'col-sm-3'>>" +
                        "<'row'<'col-sm-12't>>" + "<'row'<'col-sm-8'><'col-sm-4'>>",
                    language: {
                        url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/dt_russian-docMailLinks.json"
                    },
                    ajax: {
                        url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-incoming-process-showLogAdditionalLinkDocsMOut.php",
                        type: "POST",
                        data: {
                            koddocmail: koddocmail
                        }
            ...
            var table_listAdditionalLinkDocsMInc = $('#table-listAdditionalLinkDocsMInc')
                .dataTable({
                    ...
                    ajax: {
                        url: "<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/process/mailbox-incoming-process-showLogAdditionalLinkDocsMInc.php",
                        type: "POST",
                        data: {
                            koddocmail: koddocmail
                        }
...
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/common-modals.css">
<?php
// ----- ----- ----- ----- -----
// Подключаем форму редактирования, форму поиска и выводим таблицу
// :::
include __DIR_ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5 . "/forms/mailbox-incoming-filters.php";
// ----- ----- ----- ----- -----
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-incoming.css">
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-incoming-details.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-incoming-modal-logCheckouts.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-incoming-modal-logChanges.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-incoming-modal-logComments.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-incoming-modal-listAddFiles.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-incoming-modal-listLinkDocs.css">
...
?>
<link rel="stylesheet" href="<?php echo __ROOT . __SERVICENAME_MAILNEW . __MAIL_INCOMING_ARCHIVE_WORKPATH . __MAIL_RESTR5; ?>/css/mailbox-incoming-modal-listAdditionalLinkDocs.css">
