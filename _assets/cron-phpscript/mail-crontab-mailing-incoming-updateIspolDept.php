...
$_req1 = mysqlQuery("SELECT koddocmail, inbox_docContractor_kodzayvispol FROM mailbox_incoming WHERE inbox_docDate BETWEEN '2021-01-01 00:00:00' AND '2023-12-31 23:59:59'");
while ($_req1Rows = mysqli_fetch_assoc($_req1)) {
	...
	$_req3 = mysqlQuery("UPDATE mailbox_incoming SET inbox_docContractorDEPT='{$ispoldepts}' WHERE koddocmail='{$koddocmail}'");
	$output = "Ok";
}
// unset($_POST);
